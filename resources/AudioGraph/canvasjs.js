...
( function () {
  ...
  function za( a, c, b ) {
    "millisecond" === b ? a.setMilliseconds( a.getMilliseconds() + 1 * c ) : "second" === b ? a.setSeconds( a.getSeconds() + 1 * c ) :
    "minute" === b ? a.setMinutes(a.getMinutes() + 1 * c ) :
     "hour" === b ? a.setHours( a.getHours() + 1 * c ) :
      "day" === b ? a.setDate( a.getDate() + 1 * c ) :
       "week" === b ? a.setDate( a.getDate() + 7 * c ) :
        "month" === b ? a.setMonth( a.getMonth() + 1 * c ) :
         "year" === b && a.setFullYear( a.getFullYear() +  1 * c );
    return a;
  }
  ...
  function U( a, c, b ) {
    c.getAttribute( "state" ) !== b && ( c.setAttribute( "state", b ), c.setAttribute( "type", "button" ), c.style.position =
      "relative", c.style.margin = "0px 0px 0px 0px", c.style.padding = "3px 4px 0px 4px", c.style.cssFloat = "left",
      c.setAttribute( "title", a._cultureInfo[ b + "Text" ] ),
       c.innerHTML = "<img style='height:16px;' src='" + Ma[ b ].image + "' alt='" + a._cultureInfo[ b +"Text" ] + "' />" );
  }
  ...
  function w( a, c, b ) {
    ...
    c = c || {};
    w.base.constructor.call( this, "Chart", c, c.theme ? c.theme : "theme1" );
    var d = this;
    this._containerId = a;
  ...
  function ga( a, c ) {
    ...
    if ( x( this._options.margin ) && a._options.subtitles )
      for ( var b = a._options.subtitles,
          d = 0; d < b.length; d++ )
        if ( ( x( b[ d ].horizontalAlign ) &&
         "center" === this.horizontalAlign ||
          b[ d ].horizontalAlign === this.horizontalAlign ) &&
           ( x( b[ d ].verticalAlign ) &&
            "top" === this.verticalAlign ||
             b[ d ].verticalAlign === this.verticalAlign ) &&
              b[ d ].dockInsidePlotArea === this.dockInsidePlotArea ) {
          this.margin = 0;
          break;
        }
    ...
    wa = function () {
      ...
      return function ( h, p, k ) {
        ...
        return k = p.replace( a, function ( a ) {
          ...
          case "z":
            return ( 0 < w ? "-" : "+" ) + Math.floor( Math.abs( w ) / 60 );
          case "zz":
            return ( 0 < w ? "-" : "+" ) + Q( Math.floor( Math.abs( w ) / 60 ), 2 );
          case "zzz":
            return ( 0 < w ? "-" : "+" ) + Q( Math.floor( Math.abs( w ) / 60 ), 2 ) + Q( Math.abs( w ) % 60, 2 );
          default:
        ...
        if ( c = k.pop(), "#" === c || "0" === c )
          if ( p++, p === m ) {
            var t = g,
              g = [];
            if ( "0" === c )
              for ( c = m - l - ( t ? t.length : 0 ); 0 < c; ) t.unshift( "0" ), c--;
            for ( ; 0 < t.length; ) b = t.pop() + b, y++, 0 === y % r && ( h === q && 0 < t.length ) && ( b = f + b );
            d && ( b = "-" + b )
          } else 0 < g.length ? ( b = g.pop() + b, l++, y++ ) : "0" === c && ( b = "0" + b, l++, y++ ), 0 === y % r && ( h === q && 0 < g.length ) && ( b = f + b );
      else "E" !== c[ 0 ] && "e" !== c[ 0 ] || "0" !== c[ c.length - 1 ] || !/[eE][+-]*[0]+/.test( c ) ? "," === c ? ( h++, r = y, y = 0, 0 < g.length && ( b = f + b ) ) : b = 1 < c.length &&
  ...
  w.prototype._initialize = function () {
    ...
    if ( this._options.data )
      for ( var c = 0; c < this._options.data.length; c++ )
        if ( a++, !this._options.data[ c ].type || 0 <= w._supportedChartTypes.indexOf( this._options.data[ c ].type ) ) {
  ...
  w.prototype.categoriseDataSeries = function () {
    for ( var a = "", c = 0; c < this.data.length; c++ )
      if ( a = this.data[ c ], a.dataPoints && ( 0 !== a.dataPoints.length && a.visible ) && 0 <= w._supportedChartTypes.indexOf( a.type ) ) {
      ...
      for ( var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++ ) {
        ...
        for ( p = 0; p < h.dataPoints.length; p++ ) {
          ...
          if ( 0 < p ) {
            ...
            null !== e && null !== h.dataPoints[ p - 1 ].y && ( r = e - h.dataPoints[ p - 1 ].y,
  ...
  w.prototype._processStackedPlotUnit =
    function ( a ) {
      if ( a.dataSeriesIndexes && !( 1 > a.dataSeriesIndexes.length ) ) {
        for ( var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++ ) {
          var n = this.data[ a.dataSeriesIndexes[ k ] ],
            ...
            q = !1,
            r;
          if ( "normal" === n.axisPlacement || "xySwapped" === n.axisPlacement ) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX &&
          ...
          for ( m = 0; m < n.dataPoints.length; m++ ) {
            ...
            d > b.max && ( b.max = d );
            if ( 0 < m ) {
              var t = d - n.dataPoints[ m - 1 ].x;
              0 > t && ( t *= -1 );
              b.minDiff > t && 0 !== t && ( b.minDiff = t );
              null !== e && null !== n.dataPoints[ m - 1 ].y && ( t = e - n.dataPoints[ m - 1 ].y, 0 > t && ( t *= -1 ), c.minDiff > t && 0 !== t && ( c.minDiff = t ) )
            }
        ...
        for ( m in g ) g.hasOwnProperty( m ) && !isNaN( m ) && ( a = g[ m ], a < c.min && ( c.min = Math.min( a, p ) ), a > c.max && ( c.max = a ), m < b.viewPortMin || m > b.viewPortMax ||
          ( a < c.viewPortMin && ( c.viewPortMin = Math.min( a, p ) ), a > c.viewPortMax && ( c.viewPortMax = a ) ) );
      ...
      for ( var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = !1, h = !1, p = [], k = 0; k < a.dataSeriesIndexes.length; k++ ) {
        ...
        for ( m = 0; m < n.dataPoints.length; m++ ) {
          ...
          if ( 0 < m ) {
            ...
            0 > t && ( t *= -1 );
            b.minDiff > t && 0 !== t && ( b.minDiff = t );
            x( e ) || null === n.dataPoints[ m - 1 ].y || ( t = e - n.dataPoints[ m - 1 ].y, 0 > t && ( t *= -1 ), c.minDiff > t && 0 !== t && ( c.minDiff = t ) )
          }
          if ( d < s && !l ) null !== e && ( r = d );
          else {
            if ( !l && ( l = !0, 0 < m ) ) {
            ...
            null === e ? b.viewPortMin === d && r < d && ( b.viewPortMin = r ) : ( a.yTotals[ d ] = ( a.yTotals[ d ] ?
              a.yTotals[ d ] : 0 ) + Math.abs( e ), 0 <= e ? g = !0 : 0 > e && ( h = !0 ), p[ d ] = p[ d ] ? p[ d ] + Math.abs( e ) : Math.abs( e ) )
          }
        }
        this.plotInfo.axisXValueType = n.xValueType = f ? "dateTime" : "number"
      }
    ...
    if ( a.dataSeriesIndexes && !( 1 > a.dataSeriesIndexes.length ) )
      for ( var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0; p < a.dataSeriesIndexes.length; p++ ) {
        var k = this.data[ a.dataSeriesIndexes[ p ] ],
          ...
          l = !1,
          q, r, s;
        if ( "normal" === k.axisPlacement || "xySwapped" === k.axisPlacement ) var y = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ?
          this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
          t = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
        ...
        for ( n = 0; n < k.dataPoints.length; n++ ) {
          ...
          if ( !( d < y ) || m ) {
            ...
            null === e ? b.viewPortMin === d && q < d && ( b.viewPortMin = q ) : ( f < c.viewPortMin && ( c.viewPortMin = f ), g > c.viewPortMax && ( c.viewPortMax =
              g ) )
          }
        }
  ...
  w.prototype.getObjectAtXY = function ( a, c, b ) {
    var d = null;
  ...
  w.prototype.getAutoFontSize = function ( a, c, b ) {
    a /= 400;
  ...
  w.prototype._dispatchRangeEvent = function ( a, c ) {
    var b = {};
  ...
  w.prototype._mouseEventHandler = function ( a ) {
    ...
    w.capturedEventParam && ( d = w.capturedEventParam, "mouseup" === b && ( w.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener( "mouseup", d.chart._mouseEventHandler, !1 ) ), d.hasOwnProperty( b ) &&
        ...
        for ( var f = 0; f < this._events.length; f++ )
          if ( this._events[ f ].hasOwnProperty( b ) )
            if ( d = this._events[ f ], e = d.bounds, c.x >=
              ...
              "mousedown" === b && !0 === d.capture ? ( w.capturedEventParam = d, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener( "mouseup", this._mouseEventHandler, !1 ) ) : "mouseup" === b && ( d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener( "mouseup", this._mouseEventHandler, !1 ) );
              break
            } else d = null;
  ...
  w.prototype._plotAreaMouseDown = function ( a, c ) {
    this.isDrag = !0;
    this.dragStartPoint = {
      x: a,
      y: c
  ...
  w.prototype._plotAreaMouseUp = function ( a, c ) {
  ...
  w.prototype._plotAreaMouseMove = function ( a, c ) {
    if ( this.isDrag && "none" !== this.plotInfo.axisPlacement ) {
      ...
      if ( ( !e || 2 < Math.abs( b ) || !f || 2 < Math.abs( d ) ) && ( this.panEnabled || this.zoomEnabled ) )
        ...
        var d = e ? this.dragStartPoint.x : this.plotArea.x1,
          ...
          p = f ? c - this.dragStartPoint.y : this.plotArea.y2 -
          this.plotArea.y1;
  ...
  w.prototype._zoomPanToSelectedRegion = function ( a, c, b, d, e ) {
  ...
  w.prototype.validateRegion = function ( a, c, b, d, e ) {
    e = e || !1;
    ...
    for ( f = 0; f < k.length; f++ ) {
      ...
      if ( isFinite( g.dataInfo.minDiff ) )
        if ( !( Math.abs( l -
            m ) < 3 * Math.abs( g.dataInfo.minDiff ) || m < g.minimum || l > g.maximum ) ) p.push( g ), n.push( {
          val1: m,
          val2: l
        } ), h = !0;
        else if ( !e ) {
  ...
  w.prototype.getPixelCoordinatesOnPlotArea = function ( a, c ) {
    return {
  ...
  w.prototype.renderIndexLabels = function ( a ) {
    ...
    for ( var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++ ) {
      var k = this._indexLabels[ p ],
        ...
        m, l, q = R( "indexLabelFontColor",
          k.dataPoint, k.dataSeries ),
        g = R( "indexLabelFontSize", k.dataPoint, k.dataSeries ),
        h = R( "indexLabelFontFamily", k.dataPoint, k.dataSeries );
      m = R( "indexLabelFontStyle", k.dataPoint, k.dataSeries );
      l = R( "indexLabelFontWeight", k.dataPoint, k.dataSeries );
      var f = R( "indexLabelBackgroundColor", k.dataPoint, k.dataSeries ),
        d = R( "indexLabelMaxWidth", k.dataPoint, k.dataSeries ),
        e = R( "indexLabelWrap", k.dataPoint, k.dataSeries ),
        r = R( "indexLabelLineDashType", k.dataPoint, k.dataSeries ),
        s = R( "indexLabelLineColor", k.dataPoint, k.dataSeries ),
        ...
        z = null;
      if ( 0 <= k.dataSeries.type.indexOf( "stacked" ) || "pie" === k.dataSeries.type || "doughnut" === k.dataSeries.type ) t = this.getPercentAndTotal( k.dataSeries, k.dataPoint );
      if ( k.dataSeries.indexLabelFormatter ||
        k.dataPoint.indexLabelFormatter ) z = {
      ...
      var v = k.dataPoint.indexLabelFormatter ? k.dataPoint.indexLabelFormatter( z ) : k.dataPoint.indexLabel ? this.replaceKeywordsWithValue( k.dataPoint.indexLabel, k.dataPoint, k.dataSeries, null, k.indexKeyword ) : k.dataSeries.indexLabelFormatter ? k.dataSeries.indexLabelFormatter( z ) : k.dataSeries.indexLabel ? this.replaceKeywordsWithValue( k.dataSeries.indexLabel,
        k.dataPoint, k.dataSeries, null, k.indexKeyword ) : null;
      if ( null !== v && "" !== v ) {
        var t = R( "indexLabelPlacement", k.dataPoint, k.dataSeries ),
          z = R( "indexLabelOrientation", k.dataPoint, k.dataSeries ),
          u = k.direction,
          W = k.dataSeries.axisX,
        ...
        if ( 0 <=
          ...
          if ( k.dataPoint.x < W.viewportMinimum || k.dataPoint.x > W.viewportMaximum || k.dataPoint.y < A.viewportMinimum || k.dataPoint.y > A.viewportMaximum ) continue
        } else if ( 0 <= n.indexOf( "column" ) ) {
          if ( k.dataPoint.x < W.viewportMinimum || k.dataPoint.x > W.viewportMaximum || k.bounds.y1 > c.y2 || k.bounds.y2 < c.y1 ) continue
        } else if ( 0 <= n.indexOf( "bar" ) ) {
          if ( k.dataPoint.x < W.viewportMinimum || k.dataPoint.x > W.viewportMaximum || k.bounds.x1 > c.x2 || k.bounds.x2 <
            c.x1 ) continue
        } else if ( k.dataPoint.x < W.viewportMinimum || k.dataPoint.x > W.viewportMaximum ) continue;
        d = f = 2;
        "horizontal" === z ? ( g = q.width, h = q.height ) : ( h = q.width, g = q.height );
        if ( "normal" === this.plotInfo.axisPlacement ) {
          if ( 0 <= n.indexOf( "line" ) || 0 <= n.indexOf( "area" ) ) t = "auto", f = 4;
          else if ( 0 <= n.indexOf( "stacked" ) ) "auto" === t && ( t = "inside" );
          else if ( "bubble" === n || "scatter" === n ) t = "inside";
          m = k.point.x - g / 2;
          "inside" !== t ? ( d = c.y1, e = c.y2, 0 < u ? ( l = k.point.y - h - f - b, l < d && ( l = "auto" === t ? Math.max( k.point.y, d ) + f + b : d + f + b, w = l + h > k.point.y ) ) :
        ...
        } else 0 <= n.indexOf( "line" ) || 0 <= n.indexOf( "area" ) || 0 <= n.indexOf( "scatter" ) ? ( t = "auto", d = 4 ) : 0 <= n.indexOf( "stacked" ) ? "auto" === t && ( t = "inside" ) : "bubble" === n && ( t = "inside" ), l = k.point.y - h / 2, "inside" !== t ? ( f = c.x1, e = c.x2, 0 > u ? ( m = k.point.x - g - d - b, m < f && ( m = "auto" === t ? Math.max( k.point.x, f ) + d + b : f + d + b, w = m + g > k.point.x ) ) : ( m = k.point.x + d + b, m > e - g - d - b && ( m = "auto" === t ? Math.min( k.point.x, e ) - g - d - b : e - g - d - b, w = m < k.point.x ) ) ) : ( f = Math.max( k.bounds.x1, c.x1 ), Math.min( k.bounds.x2, c.x2 ), b = 0 <= n.indexOf( "range" ) ?
          0 > u ? Math.max( k.bounds.x1, c.x1 ) + g / 2 + d : Math.min( k.bounds.x2, c.x2 ) - g / 2 - d : ( Math.max( k.bounds.x1, c.x1 ) + Math.min( k.bounds.x2, c.x2 ) ) / 2, m = 0 > u ? Math.max( k.point.x, b ) - g / 2 : Math.min( k.point.x, b ) - g / 2, m = Math.max( m, f ) );
        "vertical" === z && ( l += h );
        q.x = m;
        q.y = l;
        q.render( !0 );
        y && ( "inside" !== t && ( 0 > n.indexOf( "bar" ) && k.point.x > c.x1 && k.point.x < c.x2 || !w ) && ( 0 > n.indexOf( "column" ) && k.point.y > c.y1 && k.point.y < c.y2 || !w ) ) && ( a.lineWidth = y, a.strokeStyle = s ? s : "gray", a.setLineDash && a.setLineDash( D( r, y ) ), a.beginPath(), a.moveTo( k.point.x, k.point.y ),
          0 <= n.indexOf( "bar" ) ? a.lineTo( m + ( 0 < k.direction ? 0 : g ), l + ( "horizontal" === z ? h : -h ) / 2 ) : 0 <= n.indexOf( "column" ) ? a.lineTo( m + g / 2, l + ( ( 0 < k.direction ? h : -h ) + ( "horizontal" === z ? h : -h ) ) / 2 ) : a.lineTo( m + g / 2, l + ( ( l < k.point.y ? h : -h ) + ( "horizontal" === z ? h : -h ) ) / 2 ), a.stroke() )
      }
    }
    return {
      source: a,
  ...
  w.prototype.renderLine = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      for ( var d = [], e = 0; e < a.dataSeriesIndexes.length; e++ ) {
        ...
        c.beginPath();
        if ( 0 < h.length ) {
          for ( var t = !1, r = 0; r < h.length; r++ )
            if ( s = h[ r ].x.getTime ? h[ r ].x.getTime() : h[ r ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !g.connectNullData || !t ) ) )
              if ( "number" !== typeof h[ r ].y ) 0 < r && !( g.connectNullData || t || q ) && ( c.stroke(), u && b.stroke() ), t = !0;
              else {
                ...
                if ( 0 < h[ r ].markerSize || 0 < g.markerSize ) {
                  var v = g.getMarkerProperties( r, s, y, c );
                  d.push( v );
                  z = C( z );
                  u && d.push( {
                    x: s,
  ...
  w.prototype.renderStepLine = function ( a ) {
    ...
    if ( !( 0 >=
      ...
      for ( var d = [], e = 0; e < a.dataSeriesIndexes.length; e++ ) {
        ...
        if ( 0 < h.length ) {
          for ( var t = !1, r = 0; r < h.length; r++ )
            if ( s = h[ r ].getTime ? h[ r ].x.getTime() : h[ r ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !g.connectNullData || !t ) ) )
              if ( "number" !== typeof h[ r ].y ) 0 < r && !( g.connectNullData || t || q ) && ( c.stroke(), u && b.stroke() ), t = !0;
              else {
                var z = y;
                s = a.axisX.convertValueToPixel( s );
                ...
                q || t ? ( !q && g.connectNullData ? ( c.setLineDash && ( g._options.nullDataLineDashType || p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType ) && ( c.stroke(), p = g.nullDataLineDashType, c.setLineDash( k ) ), c.lineTo( s, z ), c.lineTo( s, y ), u && ( b.lineTo( s, z ), b.lineTo( s, y ) ) ) : ( c.beginPath(), c.moveTo( s, y ), u && ( b.beginPath(), b.moveTo( s, y ) ) ), t = q = !1 ) : ( c.lineTo( s,
                  z ), u && b.lineTo( s, z ), c.lineTo( s, y ), u && b.lineTo( s, y ), 0 == r % 500 && ( c.stroke(), c.beginPath(), c.moveTo( s, y ), u && ( b.stroke(), b.beginPath(), b.moveTo( s, y ) ) ) );
                r < h.length - 1 && ( l !== ( h[ r ].lineColor || m ) || p !== ( h[ r ].lineDashType || g.lineDashType ) ) && ( c.stroke(), c.beginPath(), c.moveTo( s, y ), l = h[ r ].lineColor || m, c.strokeStyle = l, c.setLineDash && ( h[ r ].lineDashType ? ( p = h[ r ].lineDashType, c.setLineDash( D( p, g.lineThickness ) ) ) : ( p = g.lineDashType, c.setLineDash( n ) ) ) );
                if ( 0 < h[ r ].markerSize || 0 < g.markerSize ) z = g.getMarkerProperties( r, s, y,
                  c ), d.push( z ), v = C( v ), u && d.push( {
                  x: s,
                  y: y,
                  ctx: b,
                  type: z.type,
        ...
        if ( 0 < p.length )
          for ( y = !1, r = 0; r < p.length; r++ )
            if ( s = p[ r ].getTime ? p[ r ].x.getTime() : p[ r ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !h.connectNullData || !y ) ) )
              if ( "number" !== typeof p[ r ].y ) 0 < r && !y && ( h.connectNullData ? b.setLineDash && ( 0 < t.length && ( h._options.nullDataLineDashType || !p[ r - 1 ].lineDashType ) ) && ( t[ t.length - 1 ].newLineDashArray = n, k = h.nullDataLineDashType ) : ( c( t ), t = [] ) ), y = !0;
              else {
                s = a.axisX.convertValueToPixel( s );
                ...
                r < p.length - 1 && ( q !== ( p[ r ].lineColor || l ) || k !== ( p[ r ].lineDashType || h.lineDashType ) ) && ( q = p[ r ].lineColor || l, t[ t.length - 1 ].newStrokeStyle = q, b.setLineDash && ( p[ r ].lineDashType ? ( k = p[ r ].lineDashType, t[ t.length - 1 ].newLineDashArray = D( k, h.lineThickness ) ) : ( k = h.lineDashType, t[ t.length - 1 ].newLineDashArray = m ) ) );
                if ( 0 < p[ r ].markerSize ||
                  0 < h.markerSize ) {
                  var v = h.getMarkerProperties( r, s, y, b );
                  e.push( v );
                  z = C( z );
                  u && e.push( {
                    x: s,
  ...
  w.prototype.renderColumn = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var b = null,
        d = this.plotArea,
        e = 0,
        f, g, h, p = a.axisY.convertValueToPixel( 0 ),
        e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
        k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min( 0.15 * this.width, 0.9 * ( this.plotArea.width / a.plotType.totalDataSeries ) ) << 0,
        ...
        if ( 0 < l.length )
          for ( var q = 5 < n && m.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++ )
            if ( l[ e ].getTime ? h = l[ e ].x.getTime() : h = l[ e ].x, !( h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax ) && "number" === typeof l[ e ].y ) {
              ...
              b = C( b );
              u && M( this._eventManager.ghostCtx, f, g, r, s, b, 0, null, !1, !1, !1, !1 );
  ...
  w.prototype.renderStackedColumn = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var b = null,
        ...
        f = [],
        g = 0,
        h, p = a.axisY.convertValueToPixel( 0 ),
        g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
        k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
      ...
      !this.dataPointMaxWidth && ( this.dataPointMinWidth && k < g ) && ( k = Math.max( this.dataPointWidth ? this.dataPointWidth :
        -Infinity, g ) );
      n < g && ( n = g );
      n > k && ( n = k );
      c.save();
      ...
      for ( k = 0; k < a.dataSeriesIndexes.length; k++ ) {
        ...
        if ( 0 < q.length ) {
          ...
          for ( g = 0; g < q.length; g++ )
            if ( b = q[ g ].x.getTime ? q[ g ].x.getTime() :
              q[ g ].x, !( b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax ) && "number" === typeof q[ g ].y ) {
              d = a.axisX.convertValueToPixel( b );
              h = a.axisY.convertValueToPixel( q[ g ].y );
              var s = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                y = s + n << 0,
                t;
              if ( 0 <= q[ g ].y ) {
                var z = e[ b ] ? e[ b ] : 0;
                ...
                t = p - z;
                e[ b ] = z + ( t - h )
              } else z = f[ b ] ? f[ b ] : 0, t = h + z, h = p + z, f[ b ] = z + ( t - h );
              b = q[ g ].color ? q[ g ].color : l._colorSet[ g % l._colorSet.length ];
              M( c, s, h, y, t, b, 0, null, r && 0 <= q[ g ].y, 0 > q[ g ].y && r, !1, !1, l.fillOpacity );
              b = l.dataPointIds[ g ];
              this._eventManager.objectMap[ b ] = {
                id: b,
                objectType: "dataPoint",
              ...
              b = C( b );
              u && M( this._eventManager.ghostCtx, s, h, y, t, b, 0, null, !1, !1, !1, !1 );
              ( q[ g ].indexLabel || l.indexLabel || q[ g ].indexLabelFormatter || l.indexLabelFormatter ) && this._indexLabels.push( {
                ...
                direction: 0 > q[ g ].y === a.axisY.reversed ? 1 : -1,
                bounds: {
                  x1: s,
                  y1: Math.min( h, t ),
                  x2: y,
  ...
  w.prototype.renderStackedColumn100 = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      n = this.dataPointWidth ? this.dataPointWidth : 0.9 * ( d.width / Math.abs( a.axisX.viewportMaximum - a.axisX.viewportMinimum ) * Math.abs( n ) / a.plotType.plotUnits.length ) << 0;
      this.dataPointMaxWidth && g > k && ( g = Math.min( this.dataPointWidth ? this.dataPointWidth : Infinity, k ) );
      !this.dataPointMaxWidth && ( this.dataPointMinWidth && k < g ) && ( k = Math.max( this.dataPointWidth ?
      ...
      for ( k = 0; k < a.dataSeriesIndexes.length; k++ ) {
        var m = a.dataSeriesIndexes[ k ],
          ...
          q = l.dataPoints;
        if ( 0 < q.length )
          for ( var r = 5 < n && l.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++ )
            if ( b = q[ g ].x.getTime ? q[ g ].x.getTime() :
              q[ g ].x, !( b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax ) && "number" === typeof q[ g ].y ) {
              d = a.axisX.convertValueToPixel( b );
              h = a.axisY.convertValueToPixel( 0 !== a.dataPointYSums[ b ] ? 100 * ( q[ g ].y / a.dataPointYSums[ b ] ) : 0 );
              var s = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                y = s + n << 0,
                t;
              if ( 0 <= q[ g ].y ) {
        ...
        if ( 0 < l.length ) {
          ...
          for ( e = 0; e < l.length; e++ )
            if ( l[ e ].getTime ? h = l[ e ].x.getTime() : h = l[ e ].x, !( h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax ) && "number" === typeof l[ e ].y ) {
              ...
              0 <= l[ e ].y ? s = p : ( s = f, f = p );
              b =
                l[ e ].color ? l[ e ].color : m._colorSet[ e % m._colorSet.length ];
              ...
              b = C( b );
              u && M( this._eventManager.ghostCtx, s, g, f, r, b, 0, null, !1, !1, !1, !1 );
              ( l[ e ].indexLabel || m.indexLabel || l[ e ].indexLabelFormatter || m.indexLabelFormatter ) && this._indexLabels.push( {
                chartType: "bar",
                dataPoint: l[ e ],
                dataSeries: m,
  ...
  w.prototype.renderStackedBar = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var b = null,
        ...
        h, p = a.axisY.convertValueToPixel( 0 ),
        g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
        k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0,
        n = a.axisX.dataInfo.minDiff;
      isFinite( n ) || ( n = 0.3 * Math.abs( a.axisX.viewportMaximum - a.axisX.viewportMinimum ) );
      ...
      this.dataPointMaxWidth && g > k && ( g = Math.min( this.dataPointWidth ?
      ...
      for ( k = 0; k < a.dataSeriesIndexes.length; k++ ) {
        ...
        if ( 0 < q.length ) {
          ...
          c.strokeStyle = "#4572A7 ";
          for ( g = 0; g < q.length; g++ )
            if ( b = q[ g ].x.getTime ? q[ g ].x.getTime() : q[ g ].x, !( b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax ) && "number" === typeof q[ g ].y ) {
              d = a.axisX.convertValueToPixel( b );
              h = a.axisY.convertValueToPixel( q[ g ].y );
              var s = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                y = s + n << 0,
              ...
              if ( 0 <= q[ g ].y ) {
                ...
                h += z;
                e[ b ] = z + ( h - t )
              } else z = f[ b ] ? f[ b ] : 0, t = h - z, h = p - z, f[ b ] = z + ( h - t );
              b = q[ g ].color ? q[ g ].color :
                l._colorSet[ g % l._colorSet.length ];
              M( c, t, s, h, y, b, 0, null, r, !1, !1, !1, l.fillOpacity );
              b = l.dataPointIds[ g ];
              this._eventManager.objectMap[ b ] = {
                id: b,
                objectType: "dataPoint",
              ...
              b = C( b );
              u && M( this._eventManager.ghostCtx, t, s, h, y, b, 0, null, !1, !1, !1, !1 );
              ( q[ g ].indexLabel || l.indexLabel || q[ g ].indexLabelFormatter || l.indexLabelFormatter ) && this._indexLabels.push( {
                ...
                direction: 0 > q[ g ].y === a.axisY.reversed ?
                  1 : -1,
                bounds: {
                  x1: Math.min( t, h ),
                  y1: s,
  ...
  w.prototype.renderStackedBar100 = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      isFinite( n ) || ( n = 0.3 * Math.abs( a.axisX.viewportMaximum - a.axisX.viewportMinimum ) );
      n = this.dataPointWidth ? this.dataPointWidth : 0.9 * ( d.height / Math.abs( a.axisX.viewportMaximum - a.axisX.viewportMinimum ) * Math.abs( n ) / a.plotType.plotUnits.length ) << 0;
      this.dataPointMaxWidth && g > k && ( g = Math.min( this.dataPointWidth ? this.dataPointWidth :
        Infinity, k ) );
      !this.dataPointMaxWidth && ( this.dataPointMinWidth && k < g ) && ( k = Math.max( this.dataPointWidth ? this.dataPointWidth : -Infinity, g ) );
      n < g && ( n = g );
      n > k && ( n = k );
  ...
  w.prototype.renderArea = function ( a ) {
    function c() {
      z && ( 0 < k.lineThickness && b.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? t = y : 0 > a.axisY.viewportMaximum ?
        t = f.y1 : 0 < a.axisY.viewportMinimum && ( t = e.y2 ), b.lineTo( q, t ), b.lineTo( z.x, t ), b.closePath(), b.globalAlpha = k.fillOpacity, b.fill(), b.globalAlpha = 1, u && ( d.lineTo( q, t ), d.lineTo( z.x, t ), d.closePath(), d.fill() ), b.beginPath(), b.moveTo( q, r ), d.beginPath(), d.moveTo( q, r ), z = {
          x: q,
          y: r
        } )
    }
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      for ( h = 0; h < a.dataSeriesIndexes.length; h++ ) {
        ...
        var g = [],
          m = !0,
          l = 0,
          q, r, s, y = a.axisY.convertValueToPixel( 0 ),
          t, z = null;
        if ( 0 < n.length ) {
          var v = k._colorSet[ l % k._colorSet.length ],
            x = k._options.lineColor || v,
            w = x;
          b.fillStyle = v;
          b.strokeStyle = x;
          ...
          if ( b.setLineDash ) {
            var H = D( k.nullDataLineDashType, k.lineThickness ),
              A = k.lineDashType,
              K = D( A, k.lineThickness );
            b.setLineDash( K )
          }
          for ( var I = !0; l < n.length; l++ )
            if ( s = n[ l ].x.getTime ? n[ l ].x.getTime() : n[ l ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !k.connectNullData || !I ) ) )
              if ( "number" !== typeof n[ l ].y ) k.connectNullData || ( I || m ) || c(), I = !0;
              else {
                q = a.axisX.convertValueToPixel( s );
                r = a.axisY.convertValueToPixel( n[ l ].y );
                m || I ? ( !m && k.connectNullData ? ( b.setLineDash && ( k._options.nullDataLineDashType ||
                  A === k.lineDashType && k.lineDashType !== k.nullDataLineDashType ) && ( b.stroke(), A = k.nullDataLineDashType, b.setLineDash( H ) ), b.lineTo( q, r ), u && d.lineTo( q, r ) ) : ( b.beginPath(), b.moveTo( q, r ), u && ( d.beginPath(), d.moveTo( q, r ) ), z = {
                  x: q,
                  y: r
                } ), I = m = !1 ) : ( b.lineTo( q, r ), u && d.lineTo( q, r ), 0 == l % 250 && c() );
                l < n.length - 1 && ( w !== ( n[ l ].lineColor || x ) || A !== ( n[ l ].lineDashType || k.lineDashType ) ) && ( c(), w = n[ l ].lineColor || x, b.strokeStyle = w, b.setLineDash && ( n[ l ].lineDashType ? ( A = n[ l ].lineDashType, b.setLineDash( D( A, k.lineThickness ) ) ) : ( A = k.lineDashType,
                  b.setLineDash( K ) ) ) );
                ...
                0 !== n[ l ].markerSize && ( 0 < n[ l ].markerSize || 0 < k.markerSize ) && ( s = k.getMarkerProperties( l, q, r, b ), g.push( s ), G = C( G ), u && g.push( {
                  x: q,
                  y: r,
                  ctx: d,
                  type: s.type,
  ...
  w.prototype.renderSplineArea = function ( a ) {
    function c() {
      ...
      if ( 0 < c.length ) {
        ...
        b.fill();
        b.globalAlpha = 1;
        u && ( d.lineTo( c[ c.length - 1 ].x, s ), d.lineTo( y.x,
          s ), d.closePath(), d.fill() )
      }
    }
    var b = a.targetCanvasCtx || this.plotArea.ctx;
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      for ( h = 0; h < a.dataSeriesIndexes.length; h++ ) {
        ...
        var g = [],
          m = 0,
          l, q, r = a.axisY.convertValueToPixel( 0 ),
          s, y = null,
          t = [];
        if ( 0 < n.length ) {
          var z = k._colorSet[ m % k._colorSet.length ],
            v = k._options.lineColor || z,
            x = v;
          b.fillStyle = z;
          b.strokeStyle = v;
          b.lineWidth = k.lineThickness;
          ...
          if ( b.setLineDash ) {
            var A = D( k.nullDataLineDashType, k.lineThickness ),
              w = k.lineDashType,
              H = D( w, k.lineThickness );
            b.setLineDash( H )
          }
          for ( q = !1; m < n.length; m++ )
            if ( l = n[ m ].x.getTime ? n[ m ].x.getTime() : n[ m ].x, !( l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax &&
                ( !k.connectNullData || !q ) ) )
              if ( "number" !== typeof n[ m ].y ) 0 < m && !q && ( k.connectNullData ? b.setLineDash && ( 0 < t.length && ( k._options.nullDataLineDashType || !n[ m - 1 ].lineDashType ) ) && ( t[ t.length - 1 ].newLineDashArray = A, w = k.nullDataLineDashType ) : ( c(), t = [] ) ), q = !0;
              else {
                ...
                m < n.length - 1 && ( x !== ( n[ m ].lineColor ||
                  v ) || w !== ( n[ m ].lineDashType || k.lineDashType ) ) && ( x = n[ m ].lineColor || v, t[ t.length - 1 ].newStrokeStyle = x, b.setLineDash && ( n[ m ].lineDashType ? ( w = n[ m ].lineDashType, t[ t.length - 1 ].newLineDashArray = D( w, k.lineThickness ) ) : ( w = k.lineDashType, t[ t.length - 1 ].newLineDashArray = H ) ) );
                ...
                }( n[ m ].indexLabel || k.indexLabel ||
                  n[ m ].indexLabelFormatter || k.indexLabelFormatter ) && this._indexLabels.push( {
  ...
  w.prototype.renderStepArea = function ( a ) {
    function c() {
      z && ( 0 < k.lineThickness && b.stroke(), 0 >= a.axisY.viewportMinimum &&
        0 <= a.axisY.viewportMaximum ? t = y : 0 > a.axisY.viewportMaximum ? t = f.y1 : 0 < a.axisY.viewportMinimum && ( t = e.y2 ), b.lineTo( q, t ), b.lineTo( z.x, t ), b.closePath(), b.globalAlpha = k.fillOpacity, b.fill(), b.globalAlpha = 1, u && ( d.lineTo( q, t ), d.lineTo( z.x, t ), d.closePath(), d.fill() ), b.beginPath(), b.moveTo( q, r ), d.beginPath(), d.moveTo( q, r ), z = {
          x: q,
          y: r
        } )
    }
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      for ( h = 0; h < a.dataSeriesIndexes.length; h++ ) {
        ...
        if ( 0 < n.length ) {
          ...
          var H = "solid";
          if ( b.setLineDash ) {
            var K = D( k.nullDataLineDashType, k.lineThickness ),
              H = k.lineDashType,
              I = D( H, k.lineThickness );
            b.setLineDash( I )
          }
          for ( ; l < n.length; l++ )
            if ( s = n[ l ].x.getTime ? n[ l ].x.getTime() : n[ l ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !k.connectNullData || !v ) ) ) {
              var G = r;
              "number" !== typeof n[ l ].y ? ( k.connectNullData || ( v || m ) || c(), v = !0 ) : ( q = a.axisX.convertValueToPixel( s ), r = a.axisY.convertValueToPixel( n[ l ].y ), m || v ?
                ( !m && k.connectNullData ? ( b.setLineDash && ( k._options.nullDataLineDashType || H === k.lineDashType && k.lineDashType !== k.nullDataLineDashType ) && ( b.stroke(), H = k.nullDataLineDashType, b.setLineDash( K ) ), b.lineTo( q, G ), b.lineTo( q, r ), u && ( d.lineTo( q, G ), d.lineTo( q, r ) ) ) : ( b.beginPath(), b.moveTo( q, r ), u && ( d.beginPath(), d.moveTo( q, r ) ), z = {
                  x: q,
                  y: r
                } ), v = m = !1 ) : ( b.lineTo( q, G ), u && d.lineTo( q, G ), b.lineTo( q, r ), u && d.lineTo( q, r ), 0 == l % 250 && c() ), l < n.length - 1 && ( A !== ( n[ l ].lineColor || w ) || H !== ( n[ l ].lineDashType || k.lineDashType ) ) && ( c(), A =
                  n[ l ].lineColor || w, b.strokeStyle = A, b.setLineDash && ( n[ l ].lineDashType ? ( H = n[ l ].lineDashType, b.setLineDash( D( H, k.lineThickness ) ) ) : ( H = k.lineDashType, b.setLineDash( I ) ) ) ), G = k.dataPointIds[ l ], this._eventManager.objectMap[ G ] = {
                  id: G,
                  objectType: "dataPoint",
                  dataSeriesIndex: p,
                  dataPointIndex: l,
  ...
  w.prototype.renderStackedArea = function ( a ) {
    function c() {
      if ( !( 1 > h.length ) ) {
        for ( 0 <
          t.lineThickness && b.stroke(); 0 < h.length; ) {
          var a = h.pop();
          b.lineTo( a.x, a.y );
          u && r.lineTo( a.x, a.y )
        }
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var d = null,
        ...
        p = [],
        k = 0,
        n, m, l, q = a.axisY.convertValueToPixel( 0 ),
      ...
      for ( var s = [], f = 0; f < a.dataSeriesIndexes.length; f++ ) {
        var y = a.dataSeriesIndexes[ f ],
          t = this.data[ y ],
          z = t.dataPoints;
        t.dataPointIndexes = [];
        for ( k = 0; k < z.length; k++ ) y = z[ k ].x.getTime ? z[ k ].x.getTime() : z[ k ].x, t.dataPointIndexes[ y ] = k, s[ y ] || ( p.push( y ), s[ y ] = !0 );
        p.sort( Aa )
      }
      for ( f = 0; f < a.dataSeriesIndexes.length; f++ ) {
        ...
        if ( 0 < p.length ) {
          ...
          var w = "solid";
          if ( b.setLineDash ) {
            var A = D( t.nullDataLineDashType, t.lineThickness ),
              w = t.lineDashType,
              H = D( w, t.lineThickness );
            b.setLineDash( H )
          }
          for ( var K = !0, k = 0; k < p.length; k++ ) {
            l = p[ k ];
            var I = null,
              I = 0 <= t.dataPointIndexes[ l ] ? z[ t.dataPointIndexes[ l ] ] : {
                x: l,
                y: null
              };
            if ( !( l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && ( !t.connectNullData || !K ) ) )
              if ( "number" !==
                typeof I.y ) t.connectNullData || ( K || s ) || c(), K = !0;
              else {
                n = a.axisX.convertValueToPixel( l );
                m = a.axisY.convertValueToPixel( I.y );
                var G = g[ l ] ? g[ l ] : 0;
                m -= G;
                h.push( {
                  x: n,
                ...
                g[ l ] = q - m;
                s || K ? ( !s && t.connectNullData ? ( b.setLineDash && ( t._options.nullDataLineDashType || w === t.lineDashType && t.lineDashType !== t.nullDataLineDashType ) && ( b.stroke(), w = t.nullDataLineDashType, b.setLineDash( A ) ), b.lineTo( n, m ), u && r.lineTo( n, m ) ) : ( b.beginPath(), b.moveTo( n, m ), u && ( r.beginPath(), r.moveTo( n, m ) ) ), K = s = !1 ) : ( b.lineTo( n, m ), u && r.lineTo( n, m ),
                  0 == k % 250 && ( c(), b.moveTo( n, m ), u && r.moveTo( n, m ), h.push( {
                    x: n,
                    y: q - G
                  } ) ) );
                k < z.length - 1 && ( x !== ( z[ k ].lineColor || v ) || w !== ( z[ k ].lineDashType || t.lineDashType ) ) && ( c(), b.beginPath(), b.moveTo( n, m ), h.push( {
                  x: n,
                  y: q - G
                } ), x = z[ k ].lineColor || v, b.strokeStyle = x, b.setLineDash && ( z[ k ].lineDashType ? ( w = z[ k ].lineDashType, b.setLineDash( D( w, t.lineThickness ) ) ) : ( w = t.lineDashType, b.setLineDash( H ) ) ) );
                if ( 0 <= t.dataPointIndexes[ l ] ) {
                  var S = t.dataPointIds[ t.dataPointIndexes[ l ] ];
                  this._eventManager.objectMap[ S ] = {
                    id: S,
                    objectType: "dataPoint",
                    dataSeriesIndex: y,
                    dataPointIndex: t.dataPointIndexes[ l ],
                    x1: n,
                    y1: m
                  }
                }
                0 <= t.dataPointIndexes[ l ] && 0 !== I.markerSize && ( 0 < I.markerSize || 0 < t.markerSize ) && ( l = t.getMarkerProperties( k, n, m, b ), e.push( l ), markerColor = C( S ), u && e.push( {
                  x: n,
                  y: m,
                  ctx: r,
                  type: l.type,
  ...
  w.prototype.renderStackedArea100 = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var d = null,
        ...
        s = 0.9 * e.width / Math.abs( a.axisX.viewportMaximum - a.axisX.viewportMinimum ) * Math.abs( s ) << 0,
      ...
      for ( var t = [], e = 0; e < a.dataSeriesIndexes.length; e++ ) {
        var z = a.dataSeriesIndexes[ e ],
          ...
          x = v.dataPoints;
        v.dataPointIndexes = [];
        for ( k = 0; k < x.length; k++ ) z = x[ k ].x.getTime ? x[ k ].x.getTime() : x[ k ].x, v.dataPointIndexes[ z ] = k, t[ z ] || ( p.push( z ), t[ z ] = !0 );
        p.sort( Aa )
      }
      for ( e = 0; e < a.dataSeriesIndexes.length; e++ ) {
        ...
        h = [];
        if ( 0 < p.length ) {
          var d = v._colorSet[ k % v._colorSet.length ],
            w = v._options.lineColor || d,
            A = w;
          b.fillStyle = d;
          b.strokeStyle = w;
          ...
          var H = "solid";
          if ( b.setLineDash ) {
            var K = D( v.nullDataLineDashType, v.lineThickness ),
              H = v.lineDashType,
              I = D( H, v.lineThickness );
            b.setLineDash( I )
          }
          for ( var G = !0, k = 0; k < p.length; k++ ) {
            l = p[ k ];
            var S = null,
              S = 0 <= v.dataPointIndexes[ l ] ? x[ v.dataPointIndexes[ l ] ] : {
                x: l,
                y: null
              };
            if ( !( l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax &&
                ( !v.connectNullData || !G ) ) )
              if ( "number" !== typeof S.y ) v.connectNullData || ( G || t ) || c(), G = !0;
              else {
                m = 0 !== a.dataPointYSums[ l ] ? 100 * ( S.y / a.dataPointYSums[ l ] ) : 0;
                n = a.axisX.convertValueToPixel( l );
                m = a.axisY.convertValueToPixel( m );
                var sa = g[ l ] ? g[ l ] : 0;
                m -= sa;
                h.push( {
                  x: n,
                ...
                g[ l ] = q - m;
                t || G ? ( !t && v.connectNullData ? ( b.setLineDash && ( v._options.nullDataLineDashType || H === v.lineDashType && v.lineDashType !== v.nullDataLineDashType ) && ( b.stroke(), H = v.nullDataLineDashType, b.setLineDash( K ) ), b.lineTo( n, m ), u && y.lineTo( n, m ) ) : ( b.beginPath(),
                  b.moveTo( n, m ), u && ( y.beginPath(), y.moveTo( n, m ) ) ), G = t = !1 ) : ( b.lineTo( n, m ), u && y.lineTo( n, m ), 0 == k % 250 && ( c(), b.moveTo( n, m ), u && y.moveTo( n, m ), h.push( {
                  x: n,
                  y: q - sa
                } ) ) );
                k < x.length - 1 && ( A !== ( x[ k ].lineColor || w ) || H !== ( x[ k ].lineDashType || v.lineDashType ) ) && ( c(), b.beginPath(), b.moveTo( n, m ), h.push( {
                  x: n,
                  y: q - sa
                } ), A = x[ k ].lineColor || w, b.strokeStyle = A, b.setLineDash && ( x[ k ].lineDashType ? ( H = x[ k ].lineDashType, b.setLineDash( D( H, v.lineThickness ) ) ) : ( H = v.lineDashType, b.setLineDash( I ) ) ) );
                if ( 0 <= v.dataPointIndexes[ l ] ) {
                  var xa = v.dataPointIds[ v.dataPointIndexes[ l ] ];
                  this._eventManager.objectMap[ xa ] = {
                    id: xa,
                    objectType: "dataPoint",
                    dataSeriesIndex: z,
                    dataPointIndex: v.dataPointIndexes[ l ],
                    x1: n,
                    y1: m
                  }
                }
                0 <= v.dataPointIndexes[ l ] && 0 !== S.markerSize && ( 0 < S.markerSize || 0 < v.markerSize ) && ( l = v.getMarkerProperties( k, n, m, b ), f.push( l ), markerColor = C( xa ), u && f.push( {
                  x: n,
                  y: m,
                  ctx: y,
                  type: l.type,
                ...
                ( S.indexLabel || v.indexLabel || S.indexLabelFormatter || v.indexLabelFormatter ) && this._indexLabels.push( {
  ...
  w.prototype.renderBubble = function ( a ) {
    ...
    if ( !( 0 >= b ) ) {
      var d = this.plotArea,
        e = 0,
        f, g;
      a.axisY.convertValueToPixel( 0 );
      var h = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0,
      ...
      c.clip();
      u && ( this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect( d.x1, d.y1, d.width, d.height ), this._eventManager.ghostCtx.clip() );
      for ( var p = -Infinity, k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++ )
        for ( var m =
            a.dataSeriesIndexes[ n ], l = this.data[ m ], q = l.dataPoints, r = 0, e = 0; e < q.length; e++ ) f = q[ e ].getTime ? f = q[ e ].x.getTime() : f = q[ e ].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[ e ].z || ( r = q[ e ].z, r > p && ( p = r ), r < k && ( k = r ) );
      for ( var s = 25 * Math.PI, d = Math.max( Math.pow( 0.25 * Math.min( d.height, d.width ) / 2, 2 ) * Math.PI, s ), n = 0; n < a.dataSeriesIndexes.length; n++ )
        if ( m = a.dataSeriesIndexes[ n ], l = this.data[ m ], q = l.dataPoints, 1 == q.length && ( b = h ), 1 > b ? b = 1 : b > h && ( b = h ), 0 < q.length )
          for ( c.strokeStyle = "#4572A7 ",
            ...
            if ( f = q[ e ].getTime ? f = q[ e ].x.getTime() : f = q[ e ].x, !( f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ) && "number" === typeof q[ e ].y ) {
              ...
              g = a.axisY.convertValueToPixel( q[ e ].y );
              var r = q[ e ].z,
                y = 2 * Math.max( Math.sqrt( ( p === k ? d / 2 : s + ( d - s ) / ( p - k ) * ( r - k ) ) / Math.PI ) << 0, 1 ),
              ...
              ( q[ e ].indexLabel || l.indexLabel || q[ e ].indexLabelFormatter || l.indexLabelFormatter ) && this._indexLabels.push( {
                chartType: "bubble",
                dataPoint: q[ e ],
                dataSeries: l,
                point: {
    ...
    if ( !( 0 >= b ) ) {
      ...
      for ( var p = 0; p < a.dataSeriesIndexes.length; p++ ) {
        ...
        if ( 0 < m.length ) {
          ...
          for ( var l = 0, q = 0, e = 0; e < m.length; e++ )
            if ( f = m[ e ].getTime ? f = m[ e ].x.getTime() : f =
              m[ e ].x, !( f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ) && "number" === typeof m[ e ].y ) {
              f = a.axisX.convertValueToPixel( f );
              g = a.axisY.convertValueToPixel( m[ e ].y );
              ...
              c.globalAlpha = 1;
              Math.sqrt( ( l - f ) * ( l - f ) + ( q - g ) * ( q - g ) ) < Math.min( r.size, 5 ) && m.length > Math.min( this.plotArea.width, this.plotArea.height ) || ( l = n.dataPointIds[ e ], this._eventManager.objectMap[ l ] = {
                id: l,
                objectType: "dataPoint",
                dataSeriesIndex: k,
                dataPointIndex: e,
                x1: f,
                y1: g
              }, l = C( l ), u && P.drawMarker( r.x, r.y, this._eventManager.ghostCtx, r.type, r.size, l, l, r.borderThickness ), ( m[ e ].indexLabel || n.indexLabel || m[ e ].indexLabelFormatter || n.indexLabelFormatter ) && this._indexLabels.push( {
                chartType: "scatter",
                dataPoint: m[ e ],
                dataSeries: n,
                point: {
  ...
  w.prototype.renderCandlestick = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      a.axisY.convertValueToPixel( 0 );
      e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
      f = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth :
        0.015 * this.width;
      ...
      for ( var l = 0; l < a.dataSeriesIndexes.length; l++ ) {
        ...
        if ( 0 < s.length )
          for ( var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++ )
            if ( s[ e ].getTime ? n = s[ e ].x.getTime() : n = s[ e ].x, !( n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax ) && null !== s[ e ].y && s[ e ].y.length && "number" === typeof s[ e ].y[ 0 ] && "number" === typeof s[ e ].y[ 1 ] &&
              "number" === typeof s[ e ].y[ 2 ] && "number" === typeof s[ e ].y[ 3 ] ) {
              ...
              var t = f - m / 2 << 0,
                ...
                v = Math.round( Math.max( 1, 0.15 * m ) ),
                x = 0 === v % 2 ? 0 : 0.5,
                w = r.dataPointIds[ e ];
  ...
  w.prototype.renderRangeColumn = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      this.dataPointMaxWidth && e > f && ( e = Math.min( this.dataPointWidth ? this.dataPointWidth :
        Infinity, f ) );
      !this.dataPointMaxWidth && ( this.dataPointMinWidth && f < e ) && ( f = Math.max( this.dataPointWidth ? this.dataPointWidth : -Infinity, e ) );
      h < e && ( h = e );
      h > f && ( h = f );
        ...
        if ( 0 < m.length )
          for ( var l = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++ )
            if ( m[ e ].getTime ? g = m[ e ].x.getTime() : g = m[ e ].x, !( g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax ) && null !== m[ e ].y && m[ e ].y.length && "number" === typeof m[ e ].y[ 0 ] && "number" === typeof m[ e ].y[ 1 ] ) {
              ...
              var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - ( a.previousDataSeriesCount + p ) * h << 0 : b - a.plotType.totalDataSeries *
                h / 2 + ( a.previousDataSeriesCount + p ) * h << 0,
              ...
              b = C( s );
              u && M( this._eventManager.ghostCtx, q, d, r, f, b, 0, null, !1, !1, !1, !1 );
  ...
  w.prototype.renderRangeBar = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      a.axisY.convertValueToPixel( 0 );
      e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
      f = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min( 0.15 * this.height, 0.9 * ( this.plotArea.height /
      ...
      this.dataPointMaxWidth && e > f && ( e = Math.min( this.dataPointWidth ? this.dataPointWidth : Infinity, f ) );
      !this.dataPointMaxWidth && ( this.dataPointMinWidth && f < e ) && ( f = Math.max( this.dataPointWidth ? this.dataPointWidth :
        -Infinity, e ) );
      p < e && ( p = e );
      p > f && ( p = f );
      c.save();
      ...
      for ( var k = 0; k < a.dataSeriesIndexes.length; k++ ) {
        ...
        if ( 0 < l.length ) {
          ...
          c.strokeStyle = "#4572A7 ";
          for ( e = 0; e < l.length; e++ )
            if ( l[ e ].getTime ? h = l[ e ].x.getTime() :
              h = l[ e ].x, !( h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax ) && null !== l[ e ].y && l[ e ].y.length && "number" === typeof l[ e ].y[ 0 ] && "number" === typeof l[ e ].y[ 1 ] ) {
  ...
  w.prototype.renderRangeArea = function ( a ) {
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      ...
      for ( f = 0; f < a.dataSeriesIndexes.length; f++ ) {
        ...
        var y = null;
        if ( 0 < k.length ) {
          var t = p._colorSet[ m % p._colorSet.length ],
            z = p._options.lineColor || t,
            v = z;
          b.fillStyle = t;
          b.strokeStyle = z;
          ...
          var x = "solid";
          if ( b.setLineDash ) {
            var w = D( p.nullDataLineDashType, p.lineThickness ),
              x = p.lineDashType,
              A = D( x, p.lineThickness );
            b.setLineDash( A )
          }
          for ( var H = !0; m < k.length; m++ )
            if ( s = k[ m ].x.getTime ? k[ m ].x.getTime() : k[ m ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !p.connectNullData || !H ) ) )
              if ( null !== k[ m ].y && k[ m ].y.length && "number" === typeof k[ m ].y[ 0 ] &&
                "number" === typeof k[ m ].y[ 1 ] ) {
                l = a.axisX.convertValueToPixel( s );
                q = a.axisY.convertValueToPixel( k[ m ].y[ 0 ] );
                r = a.axisY.convertValueToPixel( k[ m ].y[ 1 ] );
                n || H ? ( p.connectNullData && !n ? ( b.setLineDash && ( p._options.nullDataLineDashType || x === p.lineDashType && p.lineDashType !== p.nullDataLineDashType ) && ( g[ g.length - 1 ].newLineDashArray = A, x = p.nullDataLineDashType, b.setLineDash( w ) ), b.lineTo( l, q ), u && d.lineTo( l, q ), g.push( {
                  x: l,
                  y: r
                  ...
                  x: l,
                  y: r
                } ), u && ( d.beginPath(), d.moveTo( l,
                  q ) ) ), H = n = !1 ) : ( b.lineTo( l, q ), g.push( {
                  x: l,
                  y: r
                } ), u && d.lineTo( l, q ), 0 == m % 250 && c() );
                s = p.dataPointIds[ m ];
                this._eventManager.objectMap[ s ] = {
                  id: s,
                  objectType: "dataPoint",
                ...
                m < k.length - 1 && ( v !== ( k[ m ].lineColor || z ) || x !== ( k[ m ].lineDashType || p.lineDashType ) ) && ( c(), v = k[ m ].lineColor || z, g[ g.length - 1 ].newStrokeStyle = v, b.strokeStyle = v, b.setLineDash && ( k[ m ].lineDashType ? ( x = k[ m ].lineDashType, g[ g.length - 1 ].newLineDashArray = D( x, p.lineThickness ), b.setLineDash( g[ g.length - 1 ].newLineDashArray ) ) :
                  ( x = p.lineDashType, g[ g.length - 1 ].newLineDashArray = A, b.setLineDash( A ) ) ) );
                if ( 0 !== k[ m ].markerSize && ( 0 < k[ m ].markerSize || 0 < p.markerSize ) ) {
                  var K = p.getMarkerProperties( m, l, r, b );
                  e.push( K );
                  var I = C( s );
                  u && e.push( {
                    x: l,
                  ...
                  K = p.getMarkerProperties( m, l, q, b );
                  e.push( K );
                  I = C( s );
                  u && e.push( {
                    x: l,
                ...
                if ( k[ m ].indexLabel || p.indexLabel || k[ m ].indexLabelFormatter ||
  ...
  w.prototype.renderRangeSplineArea = function ( a ) {
    function c( a, c ) {
      ...
      if ( 0 < e.length ) {
        ...
        for ( f = e.length - 1; 2 < f; f -= 3 ) b.bezierCurveTo( e[ f - 1 ].x, e[ f - 1 ].y, e[ f - 2 ].x, e[ f - 2 ].y, e[ f - 3 ].x, e[ f - 3 ].y ), u && d.bezierCurveTo( e[ f - 1 ].x, e[ f - 1 ].y, e[ f -
          2 ].x, e[ f - 2 ].y, e[ f - 3 ].x, e[ f - 3 ].y );
        b.closePath();
        ...
        if ( 0 < p.length ) {
          ...
          if ( b.setLineDash ) {
            var x = D( h.nullDataLineDashType, h.lineThickness ),
              z = h.lineDashType;
            v = D( z, h.lineThickness )
          }
          for ( m = !1; k < p.length; k++ )
            if ( n = p[ k ].x.getTime ? p[ k ].x.getTime() : p[ k ].x, !( n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && ( !h.connectNullData ||
                !m ) ) )
              if ( null !== p[ k ].y && p[ k ].y.length && "number" === typeof p[ k ].y[ 0 ] && "number" === typeof p[ k ].y[ 1 ] ) {
                ...
                k < p.length - 1 && ( t !== ( p[ k ].lineColor || y ) || z !== ( p[ k ].lineDashType || h.lineDashType ) ) && ( t = p[ k ].lineColor || y, q[ q.length -
                  1 ].newStrokeStyle = t, b.setLineDash && ( p[ k ].lineDashType ? ( z = p[ k ].lineDashType, q[ q.length - 1 ].newLineDashArray = D( z, h.lineThickness ) ) : ( z = h.lineDashType, q[ q.length - 1 ].newLineDashArray = v ) ) );
                ...
                if ( p[ k ].indexLabel || h.indexLabel || p[ k ].indexLabelFormatter || h.indexLabelFormatter ) this._indexLabels.push( {
                  chartType: "splineArea",
                  dataPoint: p[ k ],
                  dataSeries: h,
                  indexKeyword: 0,
                ...
                m = !1
              } else 0 < k && !m && ( h.connectNullData ? b.setLineDash && ( 0 < q.length &&
                ( h._options.nullDataLineDashType || !p[ k - 1 ].lineDashType ) ) && ( q[ q.length - 1 ].newLineDashArray = x, z = h.nullDataLineDashType ) : ( c( v, y ), q = [], r = [] ) ), m = !0;
          c( v, y );
          P.drawMarkers( e )
        }
      }
  ...
  var ya = function ( a, c, b, d, e, f, g, h, p ) {
    if ( !( 0 > b ) ) {
      ...
      if ( !u ) {
        ...
        Number( ( f % ( 2 * Math.PI ) ).toFixed( 8 ) ) ===
          k && ( g -= 1E-4 )
      }
      a.save();
      a.globalAlpha = h;
      "pie" === e ? ( a.beginPath(), a.moveTo( c.x, c.y ), a.arc( c.x, c.y, b, f, g, !1 ), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill() ) : "doughnut" === e && ( a.beginPath(), a.arc( c.x, c.y, b, f, g, !1 ), 0 <= p && a.arc( c.x, c.y, p * b, g, f, !0 ), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill() );
      a.globalAlpha = 1;
      a.restore()
    }
  };
  w.prototype.renderPie = function ( a ) {
    function c() {
      if ( k && n ) {
        for ( var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++ ) {
          ...
          h.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType :
          ...
          h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ?
            f.indexLabelBackgroundColor : k.indexLabelBackgroundColor ? k.indexLabelBackgroundColor : null;
          ...
          h.endAngle = h.startAngle + 2 * Math.PI / w * Math.abs( f.y );
          ...
          h.indexLabelTextBlock = new O( p.plotArea.ctx, {
        ...
        g = f = 0;
        m = !1;
        for ( e = 0; e < n.length; e++ ) h = q[ ( c + e ) % n.length ], 1 < a && ( h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t ) && ( f <= a / 2 && !m ? ( h.hemisphere = "right", f++ ) : ( h.hemisphere = "left", m = !0 ) );
        m = !1;
        for ( e = 0; e < n.length; e++ ) h = q[ ( d + e ) % n.length ], 1 < b && ( h.midAngle > 3 * Math.PI / 2 - t && h.midAngle <
          3 * Math.PI / 2 + t ) && ( g <= b / 2 && !m ? ( h.hemisphere = "left", g++ ) : ( h.hemisphere = "right", m = !0 ) )
      }
    }
      ...
      for ( b = 0; b < n.length; b++ ) {
        ...
        if ( d > c ) {
          var e = 0.07 * A * Math.cos( q[ b ].midAngle ),
            ...
            g = !1;
          if ( n[ b ].exploded ) {
            if ( 1E-9 < Math.abs( q[ b ].center.x - ( v.x + e ) ) || 1E-9 < Math.abs( q[ b ].center.y - ( v.y + f ) ) ) q[ b ].center.x = v.x + e * a, q[ b ].center.y =
              v.y + f * a, g = !0
          } else if ( 0 < Math.abs( q[ b ].center.x - v.x ) || 0 < Math.abs( q[ b ].center.y - v.y ) ) q[ b ].center.x = v.x + e * ( 1 - a ), q[ b ].center.y = v.y + f * ( 1 - a ), g = !0;
    ...
    function f( a, b, c ) {
      ...
      if ( 0 <= a && a < n.length ) {
        ...
        var m = 0,
          p = 0,
          p = m = m = 0;
        0 > b ? h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 > k && h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + b < k && ( b = -( k - ( h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + b ) ) ) : h.indexLabelTextBlock.y + h.indexLabelTextBlock.height /
          2 < k && h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + b > l && ( b = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + b - l );
        b = h.indexLabelTextBlock.y + b;
        k = 0;
        k = "right" === h.hemisphere ? v.x + Math.sqrt( Math.pow( s, 2 ) - Math.pow( b - v.y, 2 ) ) : v.x - Math.sqrt( Math.pow( s, 2 ) - Math.pow( b - v.y, 2 ) );
        p = v.x + A * Math.cos( h.midAngle );
        m = v.y + A * Math.sin( h.midAngle );
        ...
        for ( l = 1; l < n.length; l++ )
          if ( k =
            ( a - l + q.length ) % q.length, q[ k ].hemisphere !== q[ a ].hemisphere ) {
            k = null;
            break
        ...
        m = e( a );
        l = k = 0;
        0 > b ? ( l = "right" === h.hemisphere ? p : m, g = b, null !== l && ( p = -b, b = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - ( q[ l ].indexLabelTextBlock.y + q[ l ].indexLabelTextBlock.height /
          2 ), b - p < r && ( k = -p, l = f( l, k, c + 1 ), +l.toFixed( u ) > +k.toFixed( u ) && ( g = b > r ? -( b - r ) : -( p - ( l - k ) ) ) ) ) ) : 0 < b && ( l = "right" === h.hemisphere ? m : p, g = b, null !== l && ( p = b, b = q[ l ].indexLabelTextBlock.y - q[ l ].indexLabelTextBlock.height / 2 - ( h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 ), b - p < r && ( k = p, l = f( l, k, c + 1 ), +l.toFixed( u ) < +k.toFixed( u ) && ( g = b > r ? b - r : p - ( k - l ) ) ) ) );
        g && ( c = h.indexLabelTextBlock.y + g, b = 0, b = "right" === h.hemisphere ? v.x + Math.sqrt( Math.pow( s, 2 ) - Math.pow( c - v.y, 2 ) ) : v.x - Math.sqrt( Math.pow( s, 2 ) - Math.pow( c - v.y, 2 ) ), h.midAngle >
          Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t ? ( k = ( a - 1 + q.length ) % q.length, k = q[ k ], a = q[ ( a + 1 + q.length ) % q.length ], "left" === h.hemisphere && "right" === k.hemisphere && b > k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x - 15 : "right" === h.hemisphere && ( "left" === a.hemisphere && b < a.indexLabelTextBlock.x ) && ( b = a.indexLabelTextBlock.x + 15 ) ) : h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t && ( k = ( a - 1 + q.length ) % q.length, k = q[ k ], a = q[ ( a + 1 + q.length ) % q.length ], "right" === h.hemisphere && "left" === k.hemisphere && b < k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x +
            15 : "left" === h.hemisphere && ( "right" === a.hemisphere && b > a.indexLabelTextBlock.x ) && ( b = a.indexLabelTextBlock.x - 15 ) ), h.indexLabelTextBlock.y = c, h.indexLabelTextBlock.x = b, h.indexLabelAngle = Math.atan2( h.indexLabelTextBlock.y - v.y, h.indexLabelTextBlock.x - v.x ) )
      }
      return g
    }
      ...
      for ( var b = a = 0, c = 0, g = !0, b = 0; 10 > b && ( 1 > b || 0 < c ); b++ ) {
        ...
        if ( "inside" !== k.indexLabelPlacement ) {
          ...
          for ( a = 0; a < n.length; a++ ) {
            var h = q[ a ];
            h.indexLabelTextBlock.x = v.x + s * Math.cos( h.midAngle );
            h.indexLabelTextBlock.y = v.y + s * Math.sin( h.midAngle );
            h.indexLabelAngle = h.midAngle;
            h.radius = A;
            h.percentInnerRadius = K
          }
          for ( var t, x, a = 0; a < n.length; a++ ) {
            var h = q[ a ],
              w = e( a );
            if ( null !== w ) {
              t = q[ a ];
              ...
              var B = 0,
                B = d( t, x ) - r;
              if ( 0 > B ) {
                for ( var C = x = 0, D = 0; D < n.length; D++ ) D !== a && q[ D ].hemisphere === h.hemisphere && ( q[ D ].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? x++ :
                  C++ );
                x = B / ( x + C || 1 ) * C;
                var C = -1 * ( B - x ),
                  E = D = 0;
                "right" === h.hemisphere ? ( D = f( a, x ), C = -1 * ( B - D ), E = f( w, C ), +E.toFixed( u ) < +C.toFixed( u ) && +D.toFixed( u ) <= +x.toFixed( u ) && f( a, -( C - E ) ) ) : ( D = f( w, x ), C = -1 * ( B - D ), E = f( a, C ), +E.toFixed( u ) < +C.toFixed( u ) && +D.toFixed( u ) <= +x.toFixed( u ) && f( w, -( C - E ) ) )
              }
            }
          }
        } else
          for ( a = 0; a < n.length; a++ ) h = q[ a ], s = "pie" === k.type ? 0.7 * A : 0.8 * A, w = v.x + s * Math.cos( h.midAngle ), x = v.y + s * Math.sin( h.midAngle ), h.indexLabelTextBlock.x = w, h.indexLabelTextBlock.y = x;
        for ( a = 0; a < n.length; a++ )
          if ( h = q[ a ], w = h.indexLabelTextBlock.measureText(),
            ...
            v.x ) < A && ( w /= Math.abs( Math.sin( h.indexLabelAngle ) ), 9 < w && ( w *= 0.3 ), w > c && ( c = w ) ) );
              ...
              if ( null !== h ) {
                ...
                if ( l = 0 > B ) {
                  ...
                  var p = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                    ...
                    y = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width,
                    u = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
                  l = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < k.indexLabelTextBlock.x - m || l > y + m || p > u + m || r < s - m ? !1 : !0
                }
                l ? ( 0 > a && ( a = g ), h !== a && ( b = h, c += -B ), 0 === g % Math.max( n.length /
                  10, 3 ) && ( f = !0 ) ) : f = !0;
    ...
    if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
      var k = this.data[ a.dataSeriesIndexes[ 0 ] ],
        ...
        w = 0;
      a = !1;
      for ( var B = 0; B < n.length; B++ ) w += Math.abs( n[ B ].y ), !a && ( "undefined" !== typeof n[ B ].indexLabel && null !== n[ B ].indexLabel && 0 < n[ B ].indexLabel.toString().length ) && ( a = !0 ), !a && ( "undefined" !== typeof n[ B ].label && null !== n[ B ].label && 0 < n[ B ].label.toString().length ) &&
        ( a = !0 );
      if ( 0 !== w ) {
        ...
        var H = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ha( k.innerRadius, A ) : 0.7 * A,
          K = Math.min( H / A, ( A - 1 ) / A );
        this.pieDoughnutClickHandler = function ( a ) {
          p.isAnimating || !x( a.dataSeries.explodeOnClick ) && !a.dataSeries.explodeOnClick || ( a = a.dataPoint, a.exploded =
            a.exploded ? !1 : !0, 1 < this.dataPoints.length && p._animator.animate( 0, 500, function ( a ) {
              b( a );
              h()
            } ) )
        };
        ...
        this._animator.animate( 0, this.animatedRender ? this.animationDuration : 0, function ( a ) {
          ...
          for ( b = 0; b < n.length; b++ ) {
            ...
            d > a && ( d = a, e = !0 );
            var f = n[ b ].color ?
              n[ b ].color : k._colorSet[ b % k._colorSet.length ];
  ...
  O.prototype.render = function ( a ) {
    ...
    this.ctx.roundRect( 0, b, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor );
    this.ctx.fillStyle = this.fontColor;
    for ( b = 0; b < this._wrappedText.lines.length; b++ ) f = this._wrappedText.lines[ b ], "right" === this.horizontalAlign ? d = this.width - f.width - this.padding : "left" === this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign && ( d = ( this.width - 2 * this.padding ) / 2 - f.width / 2 + this.padding ), this.ctx.fillText( f.text, d, e ), e += f.height;
    this.ctx.font = c;
    a && this.ctx.restore()
  };
  ...
  O.prototype._wrapText = function () {
    ...
    for ( this.ctx.font = this._getFontString(); 0 < a.length; ) {
      var f = this.maxHeight - 2 * this.padding,
        g = this._getLineWithWidth( a, this.maxWidth -
          2 * this.padding, !1 );
  ...
  ga.prototype.render = function () {
    if ( this.text ) {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        h, p;
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ( null === this.maxWidth && ( this.maxWidth = c.width - 4 - g * ( "center" === this.horizontalAlign ? 2 : 1 ) ), f = 0.5 * c.height - this.margin -
        2, e = 0 ) : "center" === this.verticalAlign && ( "left" === this.horizontalAlign || "right" === this.horizontalAlign ? ( null === this.maxWidth && ( this.maxWidth = c.height - 4 ), f = 0.5 * c.width - this.margin - 2 ) : "center" === this.horizontalAlign && ( null === this.maxWidth && ( this.maxWidth = c.width - 4 ), f = 0.5 * c.height - 4 ) );
      ...
      var f = new O( this.ctx, {
        ...
        k = f.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ( "top" === this.verticalAlign ? ( d = c.y1 + 2, p = "top" ) : "bottom" === this.verticalAlign && ( d = c.y2 - 2 - k.height, p = "bottom" ), "left" === this.horizontalAlign ?
  ...
  oa.prototype.render = function () {
    ...
    var p = [],
      k = [];
    "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ( this.orientation = "horizontal", b = this.verticalAlign, f = null !== this.maxWidth ? this.maxWidth : c.width, g = null !== this.maxHeight ? this.maxHeight : 0.5 * c.height ) : "center" === this.verticalAlign &&
      ( this.orientation = "vertical", b = this.horizontalAlign, f = null !== this.maxWidth ? this.maxWidth : 0.5 * c.width, g = null !== this.maxHeight ? this.maxHeight : c.height );
    for ( var n = 0; n < this.dataSeries.length; n++ ) {
      var m = this.dataSeries[ n ];
      if ( "pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type ) {
        var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? Y.getDefaultLegendMarker( m.type ) : m.markerType,
          q = m.legendText ? m.legendText :
          ...
          y = m.legendMarkerBorderColor ? m.legendMarkerBorderColor : m.markerBorderColor,
          t = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max( 1, Math.round( 0.2 *
            s ) ) : 0,
        ...
        for ( var u = 0; u < m.dataPoints.length; u++ ) {
          var v = m.dataPoints[ u ],
            l = v.legendMarkerType ? v.legendMarkerType : m.legendMarkerType ? m.legendMarkerType : Y.getDefaultLegendMarker( m.type ),
            q = v.legendText ? v.legendText : m.legendText ? m.legendText :
            this.itemTextFormatter ? this.itemTextFormatter( {
              chart: this.chart._publicChartReference,
              legend: this._options,
              dataSeries: m,
            ...
            r = v.legendMarkerColor ? v.legendMarkerColor : m.legendMarkerColor ? m.legendMarkerColor : v.color ? v.color : m.color ? m.color : m._colorSet[ u % m._colorSet.length ],
            s = 0.75 * this.lineHeight,
            y = v.legendMarkerBorderColor ? v.legendMarkerBorderColor : m.legendMarkerBorderColor ? m.legendMarkerBorderColor : v.markerBorderColor ? v.markerBorderColor : m.markerBorderColor,
            t = v.legendMarkerBorderThickness ? v.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : v.markerBorderThickness || m.markerBorderThickness ? Math.max( 1, Math.round( 0.2 * s ) ) : 0,
            q = this.chart.replaceKeywordsWithValue( q, v, m, u ),
            l = {
              markerType: l,
              markerColor: r,
              text: q,
          ...
          ( v.showInLegend || m.showInLegend && !1 !== v.showInLegend ) && p.push( l )
        }
      ...
      for ( n = 0; n < p.length; n++ ) {
        ...
        if ( !( 0 >= g || "undefined" === typeof g || 0 >= q || "undefined" === typeof q ) ) {
          if ( "horizontal" === this.orientation ) {
            ...
            if ( !m || m.width + Math.round( l.textBlock.width + s + h + ( 0 === m.width ?
                0 : this.horizontalSpacing ) + ( "line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0 ) ) > f ) m = {
              items: [],
              width: 0
            }, k.push( m ), this.height += u, u = 0;
            u = Math.max( u, l.textBlock.height )
            ...
            l.textBlock.measureText(), null !== this.itemWidth && ( l.textBlock.width = this.itemWidth - ( s + h + ( "line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0 ) ) ), this.height < g - this.lineHeight ? ( m = {
              items: [],
              width: 0
            }, k.push( m ) ) : ( m = k[ v ], v = ( v + 1 ) % k.length ), this.height += l.textBlock.height;
          l.textBlock.x = m.width;
          l.textBlock.y = 0;
          m.width += Math.round( l.textBlock.width + s + h + ( 0 === m.width ? 0 : this.horizontalSpacing ) + ( "line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 *
            0.1 * this.lineHeight : 0 ) );
          m.items.push( l );
          this.width = Math.max( m.width, this.width )
        }
      }
      this.height = !1 === this.itemWrap ? k.length * this.lineHeight : this.height + u;
      this.height = Math.min( g, this.height );
      this.width = Math.min( f, this.width )
    }
    "top" === this.verticalAlign ? ( e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2, d = c.y1 ) : "center" === this.verticalAlign ? ( e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width /
      2, d = c.y1 + c.height / 2 - this.height / 2 ) : "bottom" === this.verticalAlign && ( e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2, d = c.y2 - this.height );
    this.items = p;
    ...
    for ( n = c = 0; n < k.length; n++ ) {
      m = k[ n ];
      for ( v = u = 0; v < m.items.length; v++ ) {
        l =
          m.items[ v ];
        r = l.textBlock.x + e + ( 0 === v ? 0.2 * s : this.horizontalSpacing );
        y = d + c;
        q = r;
        ...
        this.ctx.clip();
        if ( "line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType ) this.ctx.strokeStyle = l.lineColor, this.ctx.lineWidth = Math.ceil( this.lineHeight / 8 ), this.ctx.beginPath(), this.ctx.moveTo( r - 0.1 * this.lineHeight, y + this.lineHeight / 2 ), this.ctx.lineTo( r +
          0.85 * this.lineHeight, y + this.lineHeight / 2 ), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
        P.drawMarker( r + s / 2, y + this.lineHeight / 2, this.ctx, l.markerType, l.markerSize, l.markerColor, l.markerBorderColor, l.markerBorderThickness );
        l.textBlock.x = r + h + s;
        if ( "line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType ) l.textBlock.x += 0.1 * this.lineHeight;
        l.textBlock.y = Math.round( y + this.lineHeight / 2 );
        l.textBlock.render( !0 );
        this.ctx.restore();
        u = 0 < v ? Math.max( u, l.textBlock.height ) : l.textBlock.height;
        this.chart.data[ l.dataSeriesIndex ].visible ||
        ...
        l.y2 = this.chart._eventManager.objectMap[ l.id ].y2 = l.textBlock.y + l.textBlock.height - this.lineHeight /
          2
      }
      c += u
    }
  ...
  Y.prototype.getDefaultAxisPlacement = function () {
    var a = this.type;
    if ( "column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a ||
      "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a ) return "normal";
  ...
  Y.getDefaultLegendMarker = function ( a ) {
    if ( "column" === a || "stackedColumn" ===
      a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a ) return "square";
    ...
    for ( ;; ) {
      ...
      if ( 0 <= f && f < this.dataPoints.length ) {
        ...
        if ( l ) {
          ...
          case "rangeBar":
            a >=
              l.x1 && ( a <= l.x2 && c >= l.y1 && c <= l.y2 ) && ( d.push( {
                dataPoint: q,
                dataPointIndex: f,
                dataSeries: this,
          ...
          case "doughnut":
            ...
            r < l.radius && r > u && ( r = Math.atan2( c - s.y, a - s.x ), 0 > r && ( r += 2 * Math.PI ), r = Number( ( ( 180 * ( r / Math.PI ) % 360 + 360 ) % 360 ).toFixed( 12 ) ), s = Number( ( ( 180 * ( l.startAngle / Math.PI ) % 360 + 360 ) % 360 ).toFixed( 12 ) ), u = Number( ( ( 180 * ( l.endAngle / Math.PI ) % 360 + 360 ) % 360 ).toFixed( 12 ) ), 0 === u && 1 < l.endAngle && ( u = 360 ), s >= u && 0 !== q.y && ( u += 360, r < s && ( r += 360 ) ), r > s && r < u && ( d.push( {
              dataPoint: q,
              dataPointIndex: f,
              dataSeries: this,
              distance: 0
          ...
          case "candlestick":
            ...
            break;
          case "ohlc":
            if ( Math.abs( l.x2 - a + l.x1 - a ) < l.borderThickness && c >= l.y2 && c <= l.y3 || a >= l.x1 && a <= ( l.x2 +
                l.x1 ) / 2 && c >= l.y1 - l.borderThickness / 2 && c <= l.y1 + l.borderThickness / 2 || a >= ( l.x1 + l.x2 ) / 2 && a <= l.x2 && c >= l.y4 - l.borderThickness / 2 && c <= l.y4 + l.borderThickness / 2 ) d.push( {
              dataPoint: q,
              dataPointIndex: f,
              dataSeries: this,
              distance: Math.min( Math.abs( l.x1 - a ), Math.abs( l.x2 - a ), Math.abs( l.y2 - c ), Math.abs( l.y3 - c ) )
  ...
  Y.prototype.getMarkerProperties =
    function ( a, c, b, d ) {
  ...
  F.prototype.createLabels = function () {
    ...
    if ( "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType )
      for ( this.intervalStartPosition = this.getLabelStartPoint( new Date( this.viewportMinimum ), this.intervalType, h ), e = za( new Date( this.viewportMaximum ), h, this.intervalType ), b = this.intervalStartPosition; b < e; za( b, h, this.intervalType ) ) a = b.getTime(), a = this.labelFormatter ?
        this.labelFormatter( {
          chart: this.chart._publicChartReference,
          axis: this._options,
          value: b,
      ...
      if ( this.labels ) {
        a = Math.ceil( h );
        for ( var m = Math.ceil( this.intervalStartPosition ), d = !1, b = m; b < this.viewportMaximum; b += a )
          if ( this.labels[ b ] ) d = !0;
          else {
            d = !1;
            break
          }
        d && ( h = this.interval = a, this.intervalStartPosition = m )
      }
      for ( b = this.intervalStartPosition; b <= e; b = parseFloat( ( b + 1 * h ).toFixed( 14 ) ) ) a = this.labelFormatter ? this.labelFormatter( {
        chart: this.chart._publicChartReference,
        axis: this._options,
        value: b,
        label: this.labels[ b ] ? this.labels[ b ] : null
    ...
    if ( this.labelAutoFit || this._options.labelAutoFit )
      if ( x( this.labelAngle ) || ( this.labelAngle = ( this.labelAngle % 360 + 360 ) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && ( this.labelAngle -= 360 ) ), "bottom" === this._position || "top" === this._position ) {
        var q = 0,
          f = 0.9 * p >> 0,
          m = 0;
        if ( !this.chart.panEnabled && 1 <= this._labels.length ) {
          ...
          for ( b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++ )
            if ( a = this._labels[ b ].textBlock, l = a.measureText(), b < this._labels.length -
              ...
              if ( this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : Math.min( ( d -
          ...
          for ( b = 0; b < this._labels.length; b++ ) a = this._labels[ b ].textBlock, a.maxWidth = this.labelMaxWidth = x( this._options.labelMaxWidth ) ?
      ...
      if ( f = x( this._options.labelMaxWidth ) ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth, g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length ) {
        ...
        for ( b = 0; b < this._labels.length; b++ )( a = this._labels[ b ].textBlock, l = a.measureText(), b < this._labels.length - 1 && ( q = b + 1, c = this._labels[ q ].textBlock, c = c.measureText() ), e.push( a.height ), this.sessionVariables.labelMaxHeight = Math.max.apply( Math, e ), d = f * Math.sin( Math.PI / 180 * Math.abs( this.labelAngle ) ) + ( g - a.fontSize / 2 ) * Math.cos( Math.PI / 180 * Math.abs( this.labelAngle ) ), Math.cos( Math.PI / 180 * Math.abs( this.labelAngle ) ), Math.sin( Math.PI / 180 * Math.abs( this.labelAngle ) ), x( this._options.labelAngle ) && isNaN( this._options.labelAngle ) &&
          ...
          g, x( this._options.labelMaxWidth ), this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap );
    ...
    for ( b = 0; b < this.stripLines.length; b++ ) {
      ...
      if ( "outside" === f.labelPlacement ) {
        ...
        if ( "bottom" === this._position || "top" === this._position ) u = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
        if ( "left" === this._position ||
          "right" === this._position ) u = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
        c = x( f._options.labelBackgroundColor ) ? "#EEEEEE" : f._options.labelBackgroundColor
      } else g = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, u = "undefined" === typeof f._options.labelWrap || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >>
        0 : 1.5 * this.labelFontSize, c = x( f._options.labelBackgroundColor ) ? x( f.startValue ) && 0 !== f.startValue ? "transparent" : "#EEEEEE" : f._options.labelBackgroundColor;
      a = new O( this.ctx, {
        x: 0,
        y: 0,
        backgroundColor: c,
        ...
        horizontalAlign: "left",
        fontSize: "outside" === f.labelPlacement ? f._options.labelFontSize ? f._options.labelFontSize :
  ...
  F.prototype.createLabelsAndCalculateHeight = function () {
    ...
    if ( "bottom" === this._position || "top" === this._position ) {
      for ( b = 0; b < this._labels.length; b++ ) {
        ...
        var d = c.measureText(),
          e = 0,
          e = 0 === this.labelAngle ? d.height : d.width * Math.sin( Math.PI / 180 * Math.abs( this.labelAngle ) ) + ( d.height - c.fontSize / 2 ) * Math.cos( Math.PI /
  ...
  F.setLayoutAndRender = function ( a, c, b, d, e ) {
    ...
    if ( "normal" === d ) {
      ...
      b && b.title && ( b._titleTextBlock.maxWidth = b.titleMaxWidth || e.height, b._titleTextBlock.maxHeight = b.titleWrap ? 0.8 * e.width : 1.5 * b.titleFontSize, b._titleTextBlock.angle =
        90 );
      for ( ; 4 > l++; ) {
        a.lineCoordinates = {};
        u = Math.ceil( c ? c.createLabelsAndCalculateWidth() : 0 );
        F.push( u );
        f = Math.round( e.x1 + u + n );
        s = Math.ceil( b ? b.createLabelsAndCalculateWidth() : 0 );
        J.push( s );
        g = Math.round( e.x2 - s - m > a.chart.width - 10 ? a.chart.width - 10 : e.x2 - s - m );
        !a.labelAutoFit || ( x( v ) || x( B ) ) || ( 0 < a.labelAngle ? B + r > g && ( C += 0 < a.labelAngle ? B + r - g - s : 0 ) : 0 > a.labelAngle ? v - q < f && v - q < a.viewportMinimum && ( A = f - ( n + a.tickLength + u + v - q + a.labelFontSize / 2 ) ) : 0 === a.labelAngle && ( B + r > g && ( C = B + r / 2 - g - s ), v - q < f && v - q < a.viewportMinimum && ( A = f - n -
          a.tickLength - u - v + q / 2 ) ), a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 < a.labelAngle && 0 < C ? g -= C : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 > a.labelAngle && 0 < A ? f += A : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 === a.labelAngle && ( 0 < A && ( f += A ), 0 < C && ( g -= C ) ) );
        ...
        G.push( u );
        a._labels && 1 < a._labels.length && ( d = h = 0, h = a._labels[ 1 ], d = "dateTime" === a.chart.plotInfo.axisXValueType ? a._labels[ a._labels.length - 2 ] : a._labels[ a._labels.length - 1 ], q = h.textBlock.width * Math.cos( Math.PI / 180 * Math.abs( h.textBlock.angle ) ) + ( h.textBlock.height - d.textBlock.fontSize / 2 ) * Math.sin( Math.PI / 180 * Math.abs( h.textBlock.angle ) ), r = d.textBlock.width * Math.cos( Math.PI / 180 * Math.abs( d.textBlock.angle ) ) + ( d.textBlock.height - d.textBlock.fontSize / 2 ) * Math.sin( Math.PI /
          180 * Math.abs( d.textBlock.angle ) ) );
        p.panEnabled ? u = p.sessionVariables.axisX.height : p.sessionVariables.axisX.height = u;
        d = Math.round( e.y2 - u - a.margin );
        ...
        c && ( f = Math.round( e.x1 + c.margin ), d = Math.round( 10 > e.y1 ? 10 : e.y1 ), g = Math.round( a.lineCoordinates.x1 ), h = Math.round( e.y2 - u - a.margin ), c.lineCoordinates = {
          x1: g,
          y1: d,
          x2: g,
          y2: h,
        ...
        b && ( f = Math.round( a.lineCoordinates.x2 ), d = Math.round( 10 > e.y1 ? 10 : e.y1 ), g = Math.round( f + s ), h = Math.round( e.y2 - u - a.margin ), b.lineCoordinates = {
          x1: f,
          y1: d,
          x2: f,
          y2: h,
      ...
      b && b.title && ( b._titleTextBlock.maxWidth = c.titleMaxWidth || e.width, b._titleTextBlock.maxHeight = b.titleWrap ? 0.8 * e.height :
        1.5 * b.titleFontSize, b._titleTextBlock.angle = 0 );
      for ( ; 4 > l++; ) {
        ...
        c && ( c.lineCoordinates = {}, f = Math.round( e.x1 + C + a.margin ), g = Math.round( e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2 ), c.labelAutoFit && !x( s ) && ( f = 0 > c.labelAngle ? Math.max( f, s ) : 0 === c.labelAngle ? Math.max( f, s / 2 ) : f, g = 0 < c.labelAngle ? g - u : 0 === c.labelAngle ? g - u / 2 : g ), c.lineCoordinates.x1 = f, c.lineCoordinates.x2 = g, c.lineCoordinates.width = Math.abs( g - f ), c.title && ( c._titleTextBlock.maxWidth = 0 < c.titleMaxWidth &&
          c.titleMaxWidth < c.lineCoordinates.width ? c.titleMaxWidth : c.lineCoordinates.width ) );
        b && ( b.lineCoordinates = {}, f = Math.round( e.x1 + C + a.margin ), g = Math.round( e.x2 > b.chart.width - 10 ? b.chart.width - 10 : e.x2 ), c && c.labelAutoFit && !x( t ) && ( f = 0 < b.labelAngle ? Math.max( f, t ) : 0 === b.labelAngle ? Math.max( f, t / 2 ) : f, g -= w / 2 ), b.lineCoordinates.x1 = f, b.lineCoordinates.x2 = g, b.lineCoordinates.width = Math.abs( g - f ), b.title && ( b._titleTextBlock.maxWidth = 0 < b.titleMaxWidth && b.titleMaxWidth < b.lineCoordinates.width ? b.titleMaxWidth : b.lineCoordinates.width ) );
        ...
        c && ( d = Math.round( e.y2 -
          A - c.margin ), h = Math.round( e.y2 - n > c.chart.height - 10 ? c.chart.height - 10 : e.y2 - n ), c.lineCoordinates.y1 = d, c.lineCoordinates.y2 = d, c.boundingRect = {
          x1: f,
          y1: d,
          x2: g,
          y2: h,
        ...
        b && ( d = Math.round( e.y1 + b.margin ), h = e.y1 + b.margin + q, b.lineCoordinates.y1 = h, b.lineCoordinates.y2 = h, b.boundingRect = {
          ...
          0 < b.titleMaxWidth && b.titleMaxWidth < b.lineCoordinates.width ? b.titleMaxWidth : b.lineCoordinates.width ) );
        ...
        c && c.labelAutoFit && ( g = 0 > c.labelAngle ? Math.max( g, s ) : 0 === c.labelAngle ? Math.max( g, s / 2 ) : g, f = 0 > c.labelAngle || 0 === c.labelAngle ? g - C : f );
  ...
  F.prototype.renderLabelsTicksAndTitle = function () {
    ...
    if ( "undefined" === typeof this._options.interval ) {
      ...
      if ( "left" === this._position || "right" === this._position ) {
        for ( e = 0; e < this._labels.length; e++ ) f = this._labels[ e ], f.position < this.viewportMinimum || ( f = f.textBlock.height * Math.cos( Math.PI / 180 * this.labelAngle ) +
          f.textBlock.width * Math.sin( Math.PI / 180 * this.labelAngle ), c += f );
        c > this.lineCoordinates.height * b && this.labelAutoFit && ( a = !0 )
      }
    }
    if ( "bottom" === this._position ) {
      for ( var f, e = 0; e < this._ticks.length; e++ ) c = this._ticks[ e ], c.position < this.viewportMinimum || c.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( c.position ), this.tickThickness && ( this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? ( c.x << 0 ) + 0.5 : c.x << 0, this.ctx.beginPath(), this.ctx.moveTo( b,
        c.y << 0 ), this.ctx.lineTo( b, c.y + this.tickLength << 0 ), this.ctx.stroke() ) );
      for ( e = 0; e < this._labels.length; e++ ) f = this._labels[ e ], f.position < this.viewportMinimum || f.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( f.position ), a && 0 !== d++ % 2 && this.labelAutoFit || ( 0 === f.textBlock.angle ? ( c.x -= f.textBlock.width / 2, c.y += this.tickLength + f.textBlock.fontSize / 2 ) : ( c.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos( Math.PI / 180 * this.labelAngle ) : 0, c.y += this.tickLength + Math.abs( 0 > this.labelAngle ? f.textBlock.width *
        Math.sin( Math.PI / 180 * this.labelAngle ) - 5 : 5 ) ), f.textBlock.x = c.x, f.textBlock.y = c.y, f.textBlock.render( !0 ) ) );
      ...
      for ( e = 0; e < this._ticks.length; e++ ) c = this._ticks[ e ], c.position < this.viewportMinimum || c.position > this.viewportMaximum ||
        ( c = this.getPixelCoordinatesOnAxis( c.position ), this.tickThickness && ( this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? ( c.x << 0 ) + 0.5 : c.x << 0, this.ctx.beginPath(), this.ctx.moveTo( b, c.y << 0 ), this.ctx.lineTo( b, c.y - this.tickLength << 0 ), this.ctx.stroke() ) );
      for ( e = 0; e < this._labels.length; e++ ) f = this._labels[ e ], f.position < this.viewportMinimum || f.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( f.position ), a && 0 !== d++ % 2 && this.labelAutoFit || ( 0 === f.textBlock.angle ?
        ( c.x -= f.textBlock.width / 2, c.y -= this.tickLength + f.textBlock.height ) : ( c.x += ( f.textBlock.height - this.tickLength - this.labelFontSize / 2 ) * Math.sin( Math.PI / 180 * this.labelAngle ) - ( 0 < this.labelAngle ? f.textBlock.width * Math.cos( Math.PI / 180 * this.labelAngle ) : 0 ), c.y -= this.tickLength + ( f.textBlock.height * Math.cos( Math.PI / 180 * this.labelAngle ) + ( 0 < this.labelAngle ? f.textBlock.width * Math.sin( Math.PI / 180 * this.labelAngle ) : 0 ) ) ), f.textBlock.x = c.x, f.textBlock.y = c.y, f.textBlock.render( !0 ) ) );
      this.title && ( this._titleTextBlock.measureText(),
        this._titleTextBlock.x = this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width / 2, this._titleTextBlock.y = this.boundingRect.y1 + 1, this._titleTextBlock.render( !0 ) )
    } else if ( "left" === this._position ) {
      for ( e = 0; e < this._ticks.length; e++ ) c = this._ticks[ e ], c.position < this.viewportMinimum || c.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( c.position ), this.tickThickness && ( this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ?
        ( c.y << 0 ) + 0.5 : c.y << 0, this.ctx.beginPath(), this.ctx.moveTo( c.x << 0, b ), this.ctx.lineTo( c.x - this.tickLength << 0, b ), this.ctx.stroke() ) );
      ...
      this.title && ( this._titleTextBlock.measureText(), this._titleTextBlock.x = this.boundingRect.x1 + 1, this._titleTextBlock.y = this.lineCoordinates.height / 2 + this._titleTextBlock.width / 2 + this.lineCoordinates.y1,
        this._titleTextBlock.render( !0 ) )
    } else if ( "right" === this._position ) {
      for ( e = 0; e < this._ticks.length; e++ ) c = this._ticks[ e ], c.position < this.viewportMinimum || c.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( c.position ), this.tickThickness && ( this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? ( c.y << 0 ) + 0.5 : c.y << 0, this.ctx.beginPath(), this.ctx.moveTo( c.x << 0, b ), this.ctx.lineTo( c.x + this.tickLength << 0, b ), this.ctx.stroke() ) );
      for ( e = 0; e < this._labels.length; e++ ) f =
        this._labels[ e ], f.position < this.viewportMinimum || f.position > this.viewportMaximum || ( c = this.getPixelCoordinatesOnAxis( f.position ), a && 0 !== d++ % 2 && this.labelAutoFit || ( 0 === this.labelAngle ? ( f.textBlock.y = c.y, f.textBlock.x = c.x + this.tickLength + 5 ) : ( f.textBlock.y = 0 > this.labelAngle ? c.y : c.y - ( f.textBlock.height - f.textBlock.fontSize / 2 - 5 ) * Math.cos( Math.PI / 180 * this.labelAngle ), f.textBlock.x = 0 < this.labelAngle ? c.x + ( f.textBlock.height - f.textBlock.fontSize / 2 - 5 ) * Math.sin( Math.PI / 180 * this.labelAngle ) + this.tickLength : c.x +
          this.tickLength + 5 ), f.textBlock.render( !0 ) ) );
  ...
  F.prototype.renderInterlacedColors = function () {
    ...
    if ( ( "bottom" === this._position || "top" === this._position ) && this.interlacedColor )
      for ( a.fillStyle = this.interlacedColor,
        e = 0; e < this._ticks.length; e++ ) c ? ( c = this.getPixelCoordinatesOnAxis( this._ticks[ e ].position ), b = e + 1 > this._ticks.length - 1 ? this.getPixelCoordinatesOnAxis( this.viewportMaximum ) : this.getPixelCoordinatesOnAxis( this._ticks[ e + 1 ].position ), a.fillRect( Math.min( b.x, c.x ), d.y1, Math.abs( b.x - c.x ), Math.abs( d.y1 - d.y2 ) ), c = !1 ) : c = !0;
    else if ( ( "left" === this._position || "right" === this._position ) && this.interlacedColor )
      for ( a.fillStyle = this.interlacedColor, e = 0; e < this._ticks.length; e++ ) c ? ( b = this.getPixelCoordinatesOnAxis( this._labels[ e ].position ),
        c = e + 1 > this._ticks.length - 1 ? this.getPixelCoordinatesOnAxis( this.viewportMaximum ) : this.getPixelCoordinatesOnAxis( this._ticks[ e + 1 ].position ), a.fillRect( d.x1, Math.min( b.y, c.y ), Math.abs( d.x1 - d.x2 ), Math.abs( c.y - b.y ) ), c = !1 ) : c = !0;
    a.beginPath()
  };
  F.prototype.renderStripLinesOfThicknessType = function ( a ) {
    if ( this.stripLines && 0 < this.stripLines.length && a ) {
      for ( var c = this, b, d = 0, e = 0, f = !1, g = !1, h = [], p = [], g = !1, d = 0; d < this.stripLines.length; d++ ) {
        ...
        k._thicknessType === a && ( "pixel" === a && ( k.value < this.viewportMinimum ||
          k.value > this.viewportMaximum ) || h.push( k ) )
      }
      for ( d = 0; d < this._stripLineLabels.length; d++ )
        if ( k = this.stripLines[ d ], b = this._stripLineLabels[ d ], !( b.position < this.viewportMinimum || b.position > this.viewportMaximum ) ) {
      ...
      if ( g )
        for ( g = !1, d = 0; d < p.length; d++ ) b = p[ d ], b.stripLine.showOnTop ?
          g || ( g = !0, this.chart.addEventListener( "dataAnimationIterationEnd", function () {
  ...
  F.prototype.renderAxisLine = function () {
    ...
    } else "left" !== this._position && "right" !== this._position || !this.lineThickness || ( a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash( D( this.lineDashType, this.lineThickness ) ), c = 1 === this.lineThickness % 2 ? ( this.lineCoordinates.x1 << 0 ) + 0.5 : this.lineCoordinates.x1 <<
  ...
  F.prototype.convertPixelToValue = function ( a ) {
    if ( !a ) return null;
    var c = 0;
    return c = this.conversionParameters.minimum +
      ( ( "left" === this._position || "right" === this._position ? a.y : a.x ) - this.conversionParameters.reference ) / this.conversionParameters.pixelPerUnit
  };
  ...
  F.prototype.getXValueAt = function ( a ) {
    if ( !a ) return null;
    var c = null;
    "left" === this._position ? c = ( this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum ) / this.chart.axisX.lineCoordinates.height *
      ( this.chart.axisX.lineCoordinates.y2 - a.y ) + this.chart.axisX.viewportMinimum : "bottom" === this._position && ( c = ( this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum ) / this.chart.axisX.lineCoordinates.width * ( a.x - this.chart.axisX.lineCoordinates.x1 ) + this.chart.axisX.viewportMinimum );
    return c
  };
  F.prototype.calculateValueToPixelConversionParameters = function ( a ) {
    ...
    if ( "left" === this._position || "right" === this._position ) a.pixelPerUnit = ( this.reversed ? 1 : -1 ) * b / Math.abs( this.viewportMaximum - this.viewportMinimum ), a.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
    this.conversionParameters = a
  };
  F.prototype.convertValueToPixel = function ( a ) {
    return this.conversionParameters.reference +
      this.conversionParameters.pixelPerUnit * ( a - this.conversionParameters.minimum ) + 0.5 << 0
  };
  F.prototype.calculateAxisParameters = function () {
    ...
    var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40,
      b = 4;
    "axisX" === this.type && ( b = 100 > this.maxWidth ?
      3 : 300 > this.maxWidth ? 6 : 600 > this.maxWidth ? 8 : 6 );
    ...
    if ( "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType ) {
      ...
      this.interval = this._options && 0 < this._options.interval ? this._options.interval : F.getNiceNumber( b /
        ( a - 1 ), !0 );
    ...
    if ( null === this.minimum || null === this.maximum )
      if ( "axisX" === this.type ? ( d = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === e - d && ( b = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval, e += b, d -= b ), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs( e - d ) : 1 ) : "axisY" === this.type && ( d = null !==
    ...
    if ( !this.valueFormatString && ( this.valueFormatString =
        "#,##0.##", b = Math.abs( this.viewportMaximum - this.viewportMinimum ), 1 > b ) ) {
  ...
  F.prototype.getLabelStartPoint = function () {
    var a = E[ this.intervalType + "Duration" ] * this.interval,
      a = new Date( Math.floor( this.viewportMinimum /
        a ) * a );
    if ( "millisecond" !== this.intervalType )
      ...
      if ( 0 <
        a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds() ) a.setDate( a.getDate() + 1 ), a.setHours( 0 ), a.setMinutes( 0 ), a.setSeconds( 0 ), a.setMilliseconds( 0 )
      ...
      if ( 1 < a.getDate() || 0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() ||
        0 < a.getMilliseconds() ) a.setMonth( a.getMonth() + 1 ), a.setDate( 1 ), a.setHours( 0 ), a.setMinutes( 0 ), a.setSeconds( 0 ), a.setMilliseconds( 0 )
  ...
  pa.prototype.render = function () {
    ...
    if ( 0 < c ) {
      ...
      if ( "bottom" === this.parent._position || "top" === this.parent._position ) e = f = 1 === this.ctx.lineWidth % 2 ? ( a.x << 0 ) + 0.5 : a.x << 0, g = this.chart.plotArea.y1,
    ...
    if ( !this.chart.disableToolTip ) {
      ...
      if ( this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement ) {
        ...
        if ( 0 <= this.currentSeriesIndex ) {
          ...
          g = {};
          if ( 0 <= this.currentDataPointIndex ) b = d.dataPoints[ this.currentDataPointIndex ], g.dataSeries = d, g.dataPoint = b, g.index = this.currentDataPointIndex, g.distance = Math.abs( b.x - f );
          else {
            if ( !this.enabled || "line" !== d.type && "stepLine" !== d.type && "spline" !== d.type &&
              "area" !== d.type && "stepArea" !== d.type && "splineArea" !== d.type && "stackedArea" !== d.type && "stackedArea100" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !== d.type && "candlestick" !== d.type && "ohlc" !== d.type ) return;
          ...
          if ( !x( g.dataPoint.y ) )
            if ( g.dataSeries.axisY )
              if ( 0 < g.dataPoint.y.length ) {
                for ( b = f = 0; b < g.dataPoint.y.length; b++ ) g.dataPoint.y[ b ] < g.dataSeries.axisY.viewportMinimum ? f-- : g.dataPoint.y[ b ] >
                  g.dataSeries.axisY.viewportMaximum && f++;
                ...
                g.dataSeries.axisY.viewportMaximum + f && e.push( g ) ) : ( 0 <= g.dataSeries.type.indexOf( "100" ) || "stackedColumn" === d.type || "stackedBar" === d.type || g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum ) && e.push( g );
          else e.push( g )
        }
      }
      if ( 0 < e.length && ( this.highlightObjects( e ), this.enabled ) )
        if ( f = "", f = this.getToolTipInnerHTML( {
          ...
          this.contentDiv.innerHTML = f;
          f = !1;
          "none" === this.container.style.display && ( f = !0, this.container.style.display =
            "block" );
          try {
            this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : u ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.borderColor ? this.borderColor : e[ 0 ].dataPoint.color ? e[ 0 ].dataPoint.color : e[ 0 ].dataSeries.color ? e[ 0 ].dataSeries.color : e[ 0 ].dataSeries._colorSet[ e[ 0 ].index % e[ 0 ].dataSeries._colorSet.length ], this.contentDiv.style.borderWidth = this.borderThickness || 0 === this.borderThickness ?
              ...
              this.fontWeight : "normal", this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle : u ? "italic" : "normal"
          } catch ( h ) {}
          "pie" === e[ 0 ].dataSeries.type || "doughnut" === e[ 0 ].dataSeries.type || "funnel" === e[ 0 ].dataSeries.type || "bar" === e[ 0 ].dataSeries.type || "rangeBar" === e[ 0 ].dataSeries.type || "stackedBar" === e[ 0 ].dataSeries.type || "stackedBar100" === e[ 0 ].dataSeries.type ? g = a - 10 - this.container.clientWidth : ( g = e[ 0 ].dataSeries.axisX.convertValueToPixel( e[ 0 ].dataPoint.x ) - this.container.clientWidth << 0, g -= 10 );
          0 > g && ( g += this.container.clientWidth +
            20 );
          ...
          g += "px";
          e = 1 !== e.length || this.shared || "line" !== e[ 0 ].dataSeries.type && "stepLine" !== e[ 0 ].dataSeries.type && "spline" !== e[ 0 ].dataSeries.type && "area" !== e[ 0 ].dataSeries.type && "stepArea" !== e[ 0 ].dataSeries.type && "splineArea" !== e[ 0 ].dataSeries.type ? "bar" === e[ 0 ].dataSeries.type || "rangeBar" === e[ 0 ].dataSeries.type ||
            "stackedBar" === e[ 0 ].dataSeries.type || "stackedBar100" === e[ 0 ].dataSeries.type ? e[ 0 ].dataSeries.axisX.convertValueToPixel( e[ 0 ].dataPoint.x ) : c : e[ 0 ].dataSeries.axisY.convertValueToPixel( e[ 0 ].dataPoint.y );
          e = -e + 10;
    ...
    for ( b = 0; b < a.length; b++ ) {
      ...
      if ( ( e = this.chart._eventManager.objectMap[ e.dataSeries.dataPointIds[ e.index ] ] ) && e.objectType && "dataPoint" === e.objectType ) {
        var d = this.chart.data[ e.dataSeriesIndex ],
          ...
          g = e.dataPointIndex;
        !1 === f.highlightEnabled || !0 !== d.highlightEnabled && !0 !== f.highlightEnabled ||
  ...
  V.prototype.getToolTipInnerHTML = function ( a ) {
    ...
    if ( g && ( this.content && "function" === typeof this.content || this.contentFormatter ) ) a = {
      ...
      for ( var p =
          "", h = 0; h < a.length; h++ )
        if ( b = a[ h ].dataSeries, d = a[ h ].dataPoint, e = a[ h ].index, f = "", 0 === h && ( g && !this.content ) && ( p += "undefined" !== typeof this.chart.axisX.labels[ d.x ] ? this.chart.axisX.labels[ d.x ] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue( p, d, b, e ) ), null !== d.toolTipContent && ( "undefined" !== typeof d.toolTipContent || null !== b._options.toolTipContent ) ) {
          if ( "line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" ===
            b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type ) f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>{name}:</span>&nbsp;&nbsp;{y}";
          else if ( "bubble" === b.type ) f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent :
            this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
          else if ( "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ) f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
          ...
          null === c && ( c = "" );
          !0 === this.reversed ? ( c = this.chart.replaceKeywordsWithValue( f, d, b, e ) + c, h < a.length - 1 && ( c = "</br>" + c ) ) : ( c +=
            this.chart.replaceKeywordsWithValue( f, d, b, e ), h < a.length - 1 && ( c += "</br>" ) )
        }
      null !== c && ( c = p + c )
    } else {
      b = a[ 0 ].dataSeries;
      ...
      if ( "line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" ===
        b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type ) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>" + ( d.label ? "{label}" : "{x}" ) + ":</span>&nbsp;&nbsp;{y}";
      else if ( "bubble" === b.type ) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" +
        ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>" + ( d.label ? "{label}" : "{x}" ) + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
      ...
      else if ( "rangeColumn" === b.type || "rangeBar" ===
        b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>" + ( d.label ? "{label}" : "{x}" ) + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
      else if ( "candlestick" === b.type || "ohlc" === b.type ) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" +
        ( this.fontColor ? "" : "'color:{color};'" ) + "\"'>" + ( d.label ? "{label}" : "{x}" ) + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
      null === c && ( c = "" );
  ...
  w.prototype.getPercentAndTotal = function ( a, c ) {
    var b = null,
      d = null,
      e = null;
  ...
  w.prototype.replaceKeywordsWithValue =
    function ( a, c, b, d, e ) {
      var f = this;
      ...
      return a.replace( /\{.*?\}|"[^"]*"|'[^']*'/g, function ( a ) {
        ...
        h = null;
        if ( "color" === a ) return c.color ?
          c.color : b.color ? b.color : b._colorSet[ d % b._colorSet.length ];
        ...
        return "x" === a ? "dateTime" === f.plotInfo.axisXValueType || "dateTime" === b.xValueType || c.x && c.x.getTime ? wa( h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo ) : ba( h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ?
          b.xValueFormatString : "#,##0.########", f._cultureInfo ) : "y" === a ? ba( h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : "#,##0.########", f._cultureInfo ) : "z" === a ? ba( h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : "#,##0.########", f._cultureInfo ) : h
      } )
    };
  fa.prototype.reset = function () {
    ...
    this.previousDataPointEventObject = null;
    this.eventObjects = [];
    u && ( this.ghostCtx.clearRect( 0,
      0, this.chart.width, this.chart.height ), this.ghostCtx.beginPath() )
  };
  ...
  fa.prototype.fireEvent = function ( a, c, b ) {
    if ( a && c ) {
      ...
      "click" === c && ( "dataPoint" === a.objectType && this.chart.pieDoughnutClickHandler ) &&
  ...
  va.prototype.animate = function ( a, c, b, d, e ) {
    ...
    for ( a = []; 0 < this.animations.length; )
      if ( c = this.animations.shift(), b = ( new Date ).getTime(), d = 0, c.startTime <= b && ( d = e( Math.min( b - c.startTime, c.duration ), 0, 1, c.duration ), d = Math.min( d, 1 ), isNaN( d ) || !isFinite( d ) ) &&
        ( d = 1 ), 1 > d && a.push( c ), c.animationCallback( d ), 1 <= d && c.onComplete ) c.onComplete();
    this.animations = a;
      ...
      drawMarker: function ( a, c, b, d, e, f, g, h ) {
        if ( b ) {
          ...
          "circle" === d ? ( b.moveTo( a, c ), b.beginPath(), b.arc( a, c, e / 2, 0, 2 * Math.PI, !1 ), f && b.fill(), h && ( g ? b.stroke() : ( p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p ) ) ) : "square" === d ? ( b.beginPath(), b.rect( a - e / 2, c - e / 2, e, e ), f && b.fill(), h && ( g ? b.stroke() : ( p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p ) ) ) : "triangle" === d ? ( b.beginPath(), b.moveTo( a - e / 2, c + e / 2 ), b.lineTo( a + e / 2, c + e / 2 ), b.lineTo( a, c - e / 2 ), b.closePath(),
            f && b.fill(), h && ( g ? b.stroke() : ( p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p ) ), b.beginPath() ) : "cross" === d && ( b.strokeStyle = f, b.lineWidth = e / 4, b.beginPath(), b.moveTo( a - e / 2, c - e / 2 ), b.lineTo( a + e / 2, c + e / 2 ), b.stroke(), b.moveTo( a + e / 2, c - e / 2 ), b.lineTo( a - e / 2, c + e / 2 ), b.stroke() )
        }
      },
